...
var graph_landing_inline_default = 'var Ee="0.179.1",Mt="https://esm.sh/force-graph@1.51.4",Nt=`https://esm.sh/3d-force-graph@1.80.0?deps=three@${Ee}`,Pt=`https://esm.sh/three-spritetext@1.9.2?deps=three@${Ee}`,_t=`https://esm.sh/three@${Ee}`,It=`https://esm.sh/three@${Ee}/examples/jsm/postprocessing/UnrealBloomPass.js`,Gt=8,At=14;var re=1,xe=3.5,Ht=.05,Dt=2.6,Ot=1,Ve=1,Q=.18,ut="graph-landing:lens",dt="graph-landing:tune",Rt=.18,Ft=1.4,zt=1.25,Bt=1.15,$t=.55,ee={x:330,y:235,z:565},qe={x:0,y:0,z:0},Ke=1.3,Ut=3.2,We=1.05,je=.32,Ye=.28,Vt={wikilink:.3,tag:.22,cooc:.16,folder:.16},Xe="#a8b0c2",Ze={min:80,max:200},Je={min:40,max:110},Qe={min:160,max:280},et={min:90,max:170},tt=220,nt=2,qt=.15,Kt=.8,Wt=350,Me={min:-100,max:-190},Ne={min:72,max:116},Pe={min:130,max:260};function jt(e){return we(e-.5,0,1)}function Ge(e){if(e&&typeof e=="object")return e;throw new Error("graph-landing: expected an object in content index")}function rt(e){return Array.isArray(e)?e.filter(r=>typeof r=="string"):[]}function Yt(e){let r=[];for(let o of Object.values(e)){let n=Ge(o),u=typeof n.slug=="string"?n.slug:"";if(u.length===0)continue;let a=n.multilingual,b=a&&typeof a=="object"?a:void 0;r.push({slug:u,title:typeof n.title=="string"?n.title:u,links:rt(n.links),tags:rt(n.tags),content:typeof n.content=="string"?n.content:"",multilingual:b})}return r}function Xt(e){let r=e.replace(/\\s+/g," ").trim();return r.length<=tt?r:`${r.slice(0,tt).trimEnd()}\\u2026`}function se(e){let r=0;for(let o of e)r=r*31+o.charCodeAt(0)>>>0;return r%628/100}function ot(e){return se(e)/(2*Math.PI)}function be(e,r,o){let n=se(e),u=Math.acos(2*ot(`${e}:phi`)-1),a=r+(o-r)*ot(`${e}:r`);return{x:a*Math.sin(u)*Math.cos(n),y:a*Math.sin(u)*Math.sin(n),z:a*Math.cos(u)}}function gt(e){return e==="index"||e.endsWith("/index")}function ft(e){return e==="tags"||e.startsWith("tags/")}function Zt(e){let r=e.multilingual?.translationKey;if(r==="home"||r==="graph"||r==="about"||r==="writing")return!0;let o=e.slug;return o==="about"||o.endsWith("/about")||o.startsWith("inbox/")}function mt(e,r){for(let o of r){if(e===o)return{locale:o,permalink:""};if(e.startsWith(`${o}/`))return{locale:o,permalink:e.slice(o.length+1)}}return{locale:void 0,permalink:e}}function _e(e,r){return e.multilingual?.locale?e.multilingual.locale:mt(e.slug,r).locale}function Jt(e,r){return e.multilingual?.translationKey?`key:${e.multilingual.translationKey}`:`slug:${mt(e.slug,r).permalink}`}function Qt(e,r){let o=e.find(n=>_e(n,r.prefixes)===r.localeId)??e.find(n=>_e(n,r.prefixes)===r.sourceLocale)??e.find(n=>_e(n,r.prefixes)===void 0);if(!o)throw new Error("graph-landing: locale group had no notes to pick");return o}function we(e,r,o){return Math.min(o,Math.max(r,e))}function st(e){let r=e.split("/").filter(o=>o.length>0);return r.length<2?"root":r[0]??"root"}function pt(e){let r=e.split("/").filter(o=>o.length>0);return r[r.length-1]??""}function Le(e){return pt(e).trim().toLowerCase()}function en(e){return/^[a-z][a-z0-9+.-]*:/i.test(e)||e.startsWith("//")}function tn(e){let r=e.trim();return r.length===0||en(r)||ft(r)||gt(r)?!0:Le(r).length===0}function nn(e){return pt(e).replace(/-/g," ")}function rn(e){let r=new Map,o=new Map;for(let n of e){let u=Le(n.slug);u.length>0&&!r.has(u)&&r.set(u,n.slug);let a=n.title.trim().toLowerCase();a.length>0&&!o.has(a)&&o.set(a,n.slug);let b=a.replace(/\\s+/g,"-");b.length>0&&!o.has(b)&&o.set(b,n.slug)}return{byBasename:r,byTitle:o}}function on(e,r,o){if(r.has(e))return e;let n=Le(e),u=o.byBasename.get(n);if(u)return u;let a=o.byTitle.get(e.trim().toLowerCase())??o.byTitle.get(n);return a||null}function sn(e,r){return e.length===0?"":[...e].sort((n,u)=>(r.get(u)??0)-(r.get(n)??0))[0]??""}function an(e,r){let o=e.filter(i=>!gt(i.slug)&&!ft(i.slug)&&!Zt(i)),n=new Map;for(let i of o){let g=Jt(i,r.prefixes),p=n.get(g)??[];p.push(i),n.set(g,p)}let u=[];for(let i of n.values())u.push(Qt(i,r));let a=new Set(u.map(i=>i.slug)),b=rn(u),T=new Map,h=new Map,v=[],A=new Set,M=new Map,F=i=>{h.set(i,(h.get(i)??0)+1)},H=(i,g,p)=>i<g?`${i}|${g}|${p}`:`${g}|${i}|${p}`,S=(i,g,p,L)=>{let N=H(i,g,p);A.has(N)||(A.add(N),v.push({source:i,target:g,kind:p}),L&&(F(i),F(g)))};for(let i of u)for(let g of i.links){if(tn(g))continue;let p=on(g,a,b);if(p!==null){p!==i.slug&&S(i.slug,p,"wikilink",!0);continue}let L=`mention:${Le(g)}`;T.has(L)||T.set(L,nn(g)),S(i.slug,L,"wikilink",!0)}let U=new Set,D=new Map;for(let i of u)for(let g of i.tags){M.set(g,(M.get(g)??0)+1);let p=`tag:${g}`;U.add(p),S(i.slug,p,"tag",!0);let L=D.get(g)??[];L.push(i.slug),D.set(g,L)}for(let i of u)if(!(i.tags.length<2))for(let g=0;g<i.tags.length;g+=1)for(let p=g+1;p<i.tags.length;p+=1)S(`tag:${i.tags[g]}`,`tag:${i.tags[p]}`,"cooc",!1);let P=new Map;for(let i of u){let g=st(i.slug);if(g==="root")continue;let p=P.get(g)??[];p.push(i.slug),P.set(g,p)}for(let i of P.values()){if(i.length<2)continue;let g=[...i].sort();for(let p=0;p<g.length;p+=1){let L=g[(p+1)%g.length],N=g[(p+nt)%g.length],C=g[p];C===void 0||L===void 0||(C!==L&&!A.has(H(C,L,"wikilink"))&&S(C,L,"folder",!1),g.length>nt+1&&N!==void 0&&C!==N&&!A.has(H(C,N,"wikilink"))&&S(C,N,"folder",!1))}}let O=[...h.values()],z=O.length>0?Math.min(...O):0,W=O.length>0?Math.max(...O):0,R=i=>{let g=h.get(i)??0,p=Math.sqrt(g),L=Math.sqrt(z),C=Math.sqrt(W)-L;return C===0?(re+xe)/2:re+(p-L)/C*(xe-re)},V=[...u].sort((i,g)=>(h.get(g.slug)??0)-(h.get(i.slug)??0)),E=new Set(V.filter(i=>(h.get(i.slug)??0)>0).slice(0,Gt).map(i=>i.slug)),B=u.map(i=>{let g=E.has(i.slug),p=g?be(i.slug,Je.min,Je.max):be(i.slug,Ze.min,Ze.max);return{id:i.slug,name:i.title,type:"note",val:R(i.slug),degree:h.get(i.slug)??0,isHub:g,tag:"",slug:i.slug,folder:st(i.slug),tags:i.tags,dominantTag:sn(i.tags,M),excerpt:Xt(i.content),phase:se(i.slug),x:p.x,y:p.y,z:p.z}});for(let[i,g]of T){let p=be(i,Qe.min,Qe.max);B.push({id:i,name:g,type:"mention",val:R(i)*$t,degree:h.get(i)??0,isHub:!1,tag:"",slug:"",folder:"",tags:[],dominantTag:"",excerpt:"",phase:se(i),x:p.x,y:p.y,z:p.z})}for(let i of U){let g=i.slice(4),p=be(i,et.min,et.max);B.push({id:i,name:g,type:"tag",val:we(R(i)*.7,re,xe),degree:h.get(i)??0,isHub:!1,tag:g,slug:`tags/${g}`,folder:"tag",tags:[g],dominantTag:g,excerpt:"",phase:se(i),x:p.x,y:p.y,z:p.z})}return{nodes:B,links:v}}function ln(e){let r=new Map,o=(n,u)=>{let a=r.get(n)??new Set;a.add(u),r.set(n,a)};for(let n of e){if(n.kind!=="wikilink"&&n.kind!=="tag")continue;let u=I(n.source),a=I(n.target);o(u,a),o(a,u)}return r}function I(e){return typeof e=="string"?e:e.id}function te(e,r){let o=document.createElement("span");o.style.color=`var(${e})`,o.style.position="absolute",o.style.visibility="hidden",document.body.appendChild(o);let n=getComputedStyle(o).color;return o.remove(),n||r}function ht(){let e=getComputedStyle(document.documentElement).getPropertyValue("--bodyFont").trim();return{bg:te("--light","#ffffff"),ink:te("--darkgray","#0f0f0f"),accent:te("--secondary","#a52142"),tertiary:te("--tertiary","#c75b75"),gray:te("--gray","#737373"),font:e.length>0?e:"Inter, sans-serif"}}function ke(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function cn(){let e=document.createElement("canvas");return(e.getContext("webgl")??e.getContext("experimental-webgl"))!==null}function un(){return cn()&&!ke()}function G(){return document.documentElement.getAttribute("saved-theme")==="dark"}function Te(e){let r=e.match(/rgba?\\(\\s*(\\d+)\\s*,\\s*(\\d+)\\s*,\\s*(\\d+)/);if(r&&r[1]&&r[2]&&r[3])return{r:Number(r[1]),g:Number(r[2]),b:Number(r[3])};let o=e.match(/^#([0-9a-f]{6})$/i);if(o&&o[1]){let n=parseInt(o[1],16);return{r:n>>16&255,g:n>>8&255,b:n&255}}return null}function ne(e,r){let o=Te(e);return o?`rgba(${o.r}, ${o.g}, ${o.b}, ${r})`:e}function oe(e,r,o){let n=Te(e),u=Te(r);if(!n||!u)return e;let a=(b,T)=>Math.round(b+(T-b)*o);return`rgb(${a(n.r,u.r)}, ${a(n.g,u.g)}, ${a(n.b,u.b)})`}function bt(e){return G()?oe(e.bg,"#05070f",.88):e.bg}function dn(e){let r=Te(e);if(!r)return e;let o=n=>{let u=n/255,a=u<=.04045?u/12.92:Math.pow((u+.055)/1.055,2.4);return Math.round(a*255)};return`rgb(${o(r.r)}, ${o(r.g)}, ${o(r.b)})`}function gn(e){return dn(bt(e))}function yt(e,r){let o=0;for(let n of e)o=o*31+n.charCodeAt(0)>>>0;return r[o%r.length]??r[0]??e}function at(e,r){return e==="articles"?r.accent:e==="inbox"?r.tertiary:e==="root"?r.ink:yt(e,[r.accent,r.tertiary,r.ink,r.gray])}function fn(e,r){return e.length===0?r.ink:yt(e,[r.accent,r.tertiary])}function kt(e){let r=e.split("/").map(a=>encodeURIComponent(a)).join("/"),o=document.querySelector("base")?.getAttribute("href"),n="/";o&&o.startsWith("/")&&!o.startsWith("//")&&(n=o.endsWith("/")?o:`${o}/`);let u=`${n}${r}`.replace(/\\/{2,}/g,"/");return new URL(u,window.location.origin)}function mn(e){if(e.length===0)throw new Error("graph-landing: cannot navigate a node without a slug");let r=kt(e);window.location.assign(r.toString())}function pn(e){let r=e.default;if(typeof r!="function")throw new Error("graph-landing: CDN module did not export a graph factory");return r()}function it(e,r){e.textContent=r,e.classList.add("graph-landing__error")}async function hn(e){let o=await import(e?Nt:Mt);return e&&typeof o.default=="function"?o.default({controlType:"orbit"}):pn(o)}function bn(){try{let e=sessionStorage.getItem(ut);if(e==="hub")return"all";if(e==="all"||e==="tag"||e==="folder")return e}catch(e){console.error("[graph-landing] sessionStorage unavailable for lens persistence",e)}return"all"}function yn(){let e={nodeScale:.7,edgeScale:1,zoom:1,spread:1};try{let r=sessionStorage.getItem(dt);if(!r)return e;let o=Ge(JSON.parse(r)),n=typeof o.nodeScale=="number"?o.nodeScale:e.nodeScale,u=typeof o.edgeScale=="number"?o.edgeScale:e.edgeScale,a=typeof o.zoom=="number"?o.zoom:e.zoom,b=typeof o.spread=="number"?o.spread:e.spread;return{nodeScale:n,edgeScale:u,zoom:a,spread:b}}catch(r){return console.error("[graph-landing] sessionStorage unavailable for tune persistence",r),e}}function ye(e){try{sessionStorage.setItem(dt,JSON.stringify(e))}catch(r){console.error("[graph-landing] could not persist tune",r)}}function Ie(e){try{sessionStorage.setItem(ut,e)}catch(r){console.error("[graph-landing] could not persist lens",r)}}function kn(e){return e==="all"||e==="tag"||e==="folder"||e==="hub"}function wn(e,r){return e.type==="tag"?e.tag===r:e.tags.includes(r)}function Tn(e,r){return e.type==="note"&&e.folder===r}function lt(e,r){let o=I(r),n=e.find(u=>u.id===o);return!n||n.type!=="note"?null:n.folder}function En(e,r,o){let n=new Map;if(r==="folder"){let u=[...new Set(e.nodes.filter(a=>a.type==="note").map(a=>a.folder))];return u.forEach((a,b)=>{let T=Math.PI*2*b/Math.max(u.length,1),h={x:Math.cos(T)*o,y:Math.sin(T)*o,z:0};for(let v of e.nodes)v.type==="note"&&v.folder===a&&n.set(v.id,h)}),n}if(r==="tag"){let u=e.nodes.filter(b=>b.type==="tag"),a=new Map;u.forEach((b,T)=>{let h=Math.PI*2*T/Math.max(u.length,1);a.set(b.tag,{x:Math.cos(h)*o,y:Math.sin(h)*o,z:0})});for(let b of e.nodes)if(b.type==="tag"){let T=a.get(b.tag);T&&n.set(b.id,T)}else if(b.dominantTag.length>0){let T=a.get(b.dominantTag);T&&n.set(b.id,T)}}return n}function Ln(e,r){let o=[],n=u=>{let a=r*u;for(let b of o){let T=e(b);T&&(b.vx=(b.vx??0)+(T.x-(b.x??0))*a,b.vy=(b.vy??0)+(T.y-(b.y??0))*a,b.vz=(b.vz??0)+(T.z-(b.z??0))*a)}};return n.initialize=u=>{o=u},n}function ct(e,r,o,n){for(let u of e.querySelectorAll(r)){if(!(u instanceof HTMLElement))continue;let a=u.getAttribute(n);u.setAttribute("aria-pressed",a===o?"true":"false")}}function vn(e,r,o,n){let u=ln(r.links),a={lens:bn(),allLabels:!1,focusTag:null,focusFolder:null},b=null,T=null,h=yn(),v=()=>T??b,A=new Set(r.nodes.filter(t=>t.type==="note").sort((t,s)=>s.degree-t.degree).slice(0,At).map(t=>t.id)),M=t=>{let s=t.val;return t.isHub&&(s*=Ft),a.lens==="tag"&&t.type==="tag"&&(s*=zt),a.focusTag&&t.id===`tag:${a.focusTag}`&&(s*=Bt),s},F=t=>{let s=v();return a.allLabels||s===t.id||s!==null&&(u.get(s)?.has(t.id)??!1)?!0:A.has(t.id)},H=t=>{let s=we((M(t)-re)/5,0,1);return(Ke+s*(Ut-Ke))*h.nodeScale},S=t=>{let s=v();if(s!==null)return s===t||(u.get(s)?.has(t)??!1);if(a.focusTag===null&&a.focusFolder===null)return!0;let c=r.nodes.find(l=>l.id===t);return c?a.focusFolder!==null?Tn(c,a.focusFolder):a.focusTag!==null&&wn(c,a.focusTag):!1},U=t=>t.type==="mention"?o.current.gray:a.lens==="tag"?t.type==="tag"?o.current.tertiary:fn(t.dominantTag,o.current):a.lens==="folder"?t.type==="tag"?o.current.tertiary:at(t.folder,o.current):a.lens==="hub"?t.type==="tag"?o.current.tertiary:t.isHub?o.current.accent:o.current.ink:t.type==="tag"?o.current.tertiary:o.current.ink,D=t=>{let s=v();if(s!==null&&(s===t.id||(u.get(s)?.has(t.id)??!1)))return o.current.accent;let c=U(t);return S(t.id)?G()?t.type==="mention"?c:t.type==="tag"?oe(o.current.tertiary,"#ffffff",.22):t.isHub?oe("#fff3e4",o.current.accent,.1):oe("#ffffff",o.current.accent,.12):c:ne(c,Q)},P=t=>{let s=G();return t==="wikilink"?.34:t==="tag"?s?.22:.2:s?.12:.11},O=t=>{let s=I(t.source),c=I(t.target),l=v();return l!==null&&(s===l||c===l)?G()?.72:.62:(l!==null||a.focusTag!==null||a.focusFolder!==null)&&(!S(s)||!S(c))?P(t.kind)*Q:P(t.kind)},z=t=>{let s=I(t.source),c=I(t.target),l=v();return l!==null&&(s===l||c===l)?oe(o.current.accent,Xe,.45):G()?Xe:o.current.gray},W=t=>ne(z(t),O(t)),R=()=>r,V=t=>{if(n.use3d){if(typeof e.cameraPosition!="function")return;let s=Math.hypot(ee.x,ee.y,ee.z),c=s/we(h.zoom,.4,2.5),l=e.cameraPosition(),d=ee,f=s;if(l&&typeof l.x=="number"&&typeof l.y=="number"&&typeof l.z=="number"){let m=Math.hypot(l.x,l.y,l.z);m>1&&(d={x:l.x,y:l.y,z:l.z},f=m)}let y=c/f;e.cameraPosition({x:d.x*y,y:d.y*y,z:d.z*y},qe,t);return}typeof e.zoom=="function"&&e.zoom(h.zoom,t)},E=()=>{let t=jt(h.spread),s=Me.min+t*(Me.max-Me.min),c=Ne.min+t*(Ne.max-Ne.min),l=e.d3Force("charge");l?.strength&&l.strength(s);let d=e.d3Force("link");d?.distance&&d.distance(w=>a.lens==="tag"&&w.kind==="tag"?c*.72:c),d?.strength&&d.strength(w=>{if(w.kind==="cooc"||w.kind==="folder")return .04;if(a.lens==="tag"&&w.kind==="tag")return .95;if(a.lens==="folder"){let x=lt(r.nodes,w.source),_=lt(r.nodes,w.target);if(x!==null&&x===_)return .72}return w.kind==="tag"?.65:.8});let f=e.d3Force("center");f?.strength&&f.strength(Ht);let y=Pe.min+t*(Pe.max-Pe.min),m=En(r,a.lens,y),k=a.lens==="folder"||a.lens==="tag"?.08:0;e.d3Force("cluster",Ln(w=>m.get(w.id)??null,k)),n.use3d&&e.d3Force("flattenZ",null)},B=new Map,i=()=>{if(!n.use3d||typeof e.nodeThreeObject!="function")return;let t=n.spriteText,s=n.three;B.clear(),typeof e.nodeThreeObjectExtend=="function"&&e.nodeThreeObjectExtend(s===null),e.nodeThreeObject(c=>{let l=H(c),d=D(c),f=!1;if(s)if(G()){let w=c.isHub?1.35:1.1,x=new s.MeshLambertMaterial({color:d,emissive:d,emissiveIntensity:w});B.set(c.id,{material:x,base:w,phase:c.phase}),f=new s.Mesh(new s.SphereGeometry(l,14,14),x)}else f=new s.Mesh(new s.SphereGeometry(l,14,14),new s.MeshBasicMaterial({color:d}));if(!F(c)||!t)return f;let y=new t(c.name),m=G()?"rgba(255, 255, 255, 0.85)":o.current.ink;if(y.color=S(c.id)?m:ne(m,Q),y.fontWeight="400",y.strokeWidth=0,y.textHeight=A.has(c.id)?6.5:5.5,y.center.set(0,.5),y.position.x=l+2,y.position.y=0,!s||f===!1)return y;let k=new s.Group;return k.add(f),k.add(y),k})},g=()=>{let t=n.three;if(!n.use3d||!t||typeof e.linkThreeObject!="function")return;let s=new t.Vector3(0,1,0);e.linkThreeObject(c=>{let l=Vt[c.kind]*h.edgeScale,d=new t.MeshBasicMaterial({color:z(c),transparent:!0,opacity:O(c),depthWrite:!1});return new t.Mesh(new t.CylinderGeometry(l,l,1,5),d)}),typeof e.linkPositionUpdate=="function"&&e.linkPositionUpdate((c,l)=>{let d=l.end.x-l.start.x,f=l.end.y-l.start.y,y=l.end.z-l.start.z,m=Math.sqrt(d*d+f*f+y*y);return c.position.x=(l.start.x+l.end.x)/2,c.position.y=(l.start.y+l.end.y)/2,c.position.z=(l.start.z+l.end.z)/2,c.scale.x=1,c.scale.y=Math.max(m,.01),c.scale.z=1,c.quaternion.setFromUnitVectors(s,new t.Vector3(d,f,y).normalize()),!0})},p=()=>{!n.use3d||typeof e.linkDirectionalParticles!="function"||e.linkDirectionalParticles(t=>{let s=v();if(s===null)return 0;let c=I(t.source),l=I(t.target);return c===s||l===s?2:0})},L=()=>{e.nodeVal(M),e.nodeColor(D),e.linkColor(W),e.linkWidth(t=>{let s=I(t.source),c=I(t.target),l=v(),d=h.edgeScale;return l!==null&&(s===l||c===l)?.7*d:t.kind==="wikilink"?.5*d:(t.kind==="tag"?.35:.25)*d}),typeof e.linkOpacity=="function"&&e.linkOpacity(Ve),p(),g(),n.use3d||e.nodeCanvasObjectMode(()=>"replace")},N=()=>{let t=n.root.querySelector("[data-graph-legend]");if(!(t instanceof HTMLElement))return;let s=(f,y)=>{let m=document.createElement("span");m.className="graph-landing__legend-item";let k=document.createElement("span");k.className="graph-landing__dot",k.setAttribute("aria-hidden","true"),k.style.background=f;let w=document.createElement("span");return w.textContent=y,m.append(k,w),m},c=n.root.dataset.legendNotes??"Notes",l=n.root.dataset.legendTags??"Tags",d=n.root.dataset.legendMentions??"Mentions";t.replaceChildren(s(o.current.ink,c),s(o.current.tertiary,l),s(o.current.gray,d))},C=t=>{let s=document.createElement("li"),c=document.createElement("button");c.type="button",c.className="graph-landing__tag-item",c.dataset[t.dataset.key]=t.dataset.value,c.setAttribute("aria-pressed",t.pressed?"true":"false");let l=document.createElement("span");if(l.className="graph-landing__facet-name",t.dotColor!==null){let f=document.createElement("span");f.className="graph-landing__dot",f.style.background=t.dotColor,l.append(f)}l.append(document.createTextNode(t.label));let d=document.createElement("span");return d.className="graph-landing__tag-count",d.textContent=String(t.count),c.append(l,d),s.append(c),s},Ae=()=>{let t=n.root.querySelector("[data-graph-tags]");if(!(t instanceof HTMLElement))return;let s=n.root.querySelector("[data-graph-facet-label]"),c=n.root.querySelector(".graph-landing__tags");if(a.lens==="folder"){let d=n.root.dataset.folderRootLabel??"root",f=new Map;for(let m of r.nodes)m.type==="note"&&f.set(m.folder,(f.get(m.folder)??0)+1);let y=[...f.entries()].sort((m,k)=>k[1]-m[1]);s instanceof HTMLElement&&(s.textContent=n.root.dataset.legendFolders??"Folders"),c instanceof HTMLElement&&(c.hidden=y.length===0),t.replaceChildren(...y.map(([m,k])=>C({dataset:{key:"graphFolder",value:m},pressed:a.focusFolder===m,dotColor:at(m,o.current),label:m==="root"?d:m,count:k})));return}let l=r.nodes.filter(d=>d.type==="tag").sort((d,f)=>f.degree-d.degree).slice(0,16);s instanceof HTMLElement&&(s.textContent=n.root.dataset.legendTags??"Tags"),c instanceof HTMLElement&&(c.hidden=l.length===0),t.replaceChildren(...l.map(d=>C({dataset:{key:"graphTag",value:d.tag},pressed:a.focusTag===d.tag,dotColor:null,label:d.tag,count:d.degree})))},ae=()=>{e.graphData(R()),E(),L(),i(),N(),Ae(),ct(n.root,"[data-graph-lens]",a.lens,"data-graph-lens"),e.d3ReheatSimulation()},wt=t=>{a.lens=t,t!=="tag"&&(a.focusTag=null),t!=="folder"&&(a.focusFolder=null),Ie(t),ae()},Tt=t=>{a.focusTag=a.focusTag===t?null:t,a.focusFolder=null,a.focusTag&&(a.lens="tag",Ie("tag")),ae()},Et=t=>{a.focusFolder=a.focusFolder===t?null:t,a.focusTag=null,a.focusFolder&&(a.lens="folder",Ie("folder")),ae()},He=()=>n.use3d?gn(o.current):bt(o.current);e.graphData(R()),e.backgroundColor(He()),e.nodeLabel(t=>t.name),e.nodeRelSize(Dt),typeof e.nodeOpacity=="function"&&e.nodeOpacity(Ot),typeof e.linkOpacity=="function"&&e.linkOpacity(Ve),E(),L();let q=n.root.querySelector("[data-graph-preview]"),ie=n.root.querySelector("[data-graph-preview-chip]"),le=n.root.querySelector("[data-graph-preview-title]"),ce=n.root.querySelector("[data-graph-preview-excerpt]"),ue=0;window.addCleanup(()=>window.clearTimeout(ue));let Lt=t=>{if(!(q instanceof HTMLElement)||!(ie instanceof HTMLElement)||!(le instanceof HTMLElement)||!(ce instanceof HTMLElement))return;window.clearTimeout(ue);let s=n.root.dataset.legendNotes??"Notes",c=n.root.dataset.legendTags??"Tags",l=n.root.dataset.legendMentions??"Mentions";if(t.type==="tag"){let d=n.root.dataset.previewTagTemplate??"{n} notes";ie.textContent=c,le.textContent=`#${t.tag}`,ce.textContent=d.replace("{n}",String(t.degree))}else t.type==="mention"?(ie.textContent=l,le.textContent=t.name,ce.textContent=n.root.dataset.previewMention??"Mentioned, not published yet"):(ie.textContent=s,le.textContent=t.name,ce.textContent=t.excerpt);q.hidden=!1,q.dataset.visible="true"},De=()=>{q instanceof HTMLElement&&(window.clearTimeout(ue),ue=window.setTimeout(()=>{q.dataset.visible="false",q.hidden=!0},Wt))};if(e.onNodeHover(t=>{b=t?t.id:null,T===null&&(t?Lt(t):De()),L(),n.use3d&&i()}),n.use3d){if(typeof e.showNavInfo=="function"&&e.showNavInfo(!1),typeof e.enableNavigationControls=="function"&&e.enableNavigationControls(!0),!ke()&&typeof e.controls=="function"){let t=e.controls();t.autoRotate=!1,t.autoRotateSpeed=Rt;let s=window.setTimeout(()=>{typeof e.controls=="function"&&(e.controls().autoRotate=!0)},1600);window.addCleanup(()=>window.clearTimeout(s))}if(e.warmupTicks(50),e.cooldownTicks(200),typeof e.linkDirectionalParticleWidth=="function"&&e.linkDirectionalParticleWidth(1.1),typeof e.linkDirectionalParticleSpeed=="function"&&e.linkDirectionalParticleSpeed(.004),typeof e.linkDirectionalParticleColor=="function"&&e.linkDirectionalParticleColor(()=>o.current.accent),n.bloomPass&&typeof e.postProcessingComposer=="function"&&(n.bloomPass.strength=G()?We:0,n.bloomPass.radius=je,n.bloomPass.threshold=Ye,e.postProcessingComposer().addPass(n.bloomPass)),typeof e.cameraPosition=="function"&&(e.cameraPosition(ee,qe),h.zoom!==1&&V(0)),i(),!ke()){let t=0,s=()=>{let c=performance.now()/1e3*Kt;for(let l of B.values())l.material.emissiveIntensity=l.base*(1+qt*Math.sin(c+l.phase));t=window.requestAnimationFrame(s)};t=window.requestAnimationFrame(s),window.addCleanup(()=>window.cancelAnimationFrame(t))}}else e.warmupTicks(60),e.cooldownTicks(180),e.nodeCanvasObject((t,s,c)=>{let l=H(t),d=t.x??0,f=t.y??0;if(s.save(),s.beginPath(),s.arc(d,f,l,0,Math.PI*2),s.fillStyle=D(t),s.fill(),t.isHub&&(s.strokeStyle=S(t.id)?o.current.accent:ne(o.current.accent,Q),s.lineWidth=1.2/c,s.stroke()),F(t)){let y=11.5/c;s.font=`${y}px ${o.current.font}`,s.fillStyle=S(t.id)?o.current.ink:ne(o.current.ink,Q),s.textAlign="center",s.textBaseline="bottom",s.fillText(t.name,d,f-l-6)}s.restore()}),typeof e.nodePointerAreaPaint=="function"&&e.nodePointerAreaPaint((t,s,c)=>{let l=H(t)+8;c.beginPath(),c.arc(t.x??0,t.y??0,l,0,Math.PI*2),c.fillStyle=s,c.fill()});let de=n.root.querySelector("[data-graph-inspect]"),ge=n.root.querySelector("[data-graph-inspect-chip]"),fe=n.root.querySelector("[data-graph-inspect-title]"),me=n.root.querySelector("[data-graph-inspect-excerpt]"),ve=n.root.querySelector("[data-graph-inspect-tags]"),Se=n.root.querySelector("[data-graph-inspect-connected]"),j=n.root.querySelector("[data-graph-inspect-open]"),pe=t=>{n.root.dataset.railOpen=t?"true":"false";let s=n.root.querySelector("[data-graph-rail-toggle]"),c=n.root.querySelector("[data-graph-rail-scrim]");s instanceof HTMLButtonElement&&s.setAttribute("aria-expanded",t?"true":"false"),c instanceof HTMLElement&&(c.hidden=!t)},Oe=t=>{ke()||typeof e.controls!="function"||(e.controls().autoRotate=t)},vt=t=>{let s=u.get(t.id)??new Set,c=[];for(let l of s){let d=r.nodes.find(f=>f.id===l);d&&c.push(d)}return c.sort((l,d)=>d.degree-l.degree)},St=t=>{if(!(de instanceof HTMLElement)||!(ge instanceof HTMLElement)||!(fe instanceof HTMLElement)||!(me instanceof HTMLElement)||!(ve instanceof HTMLElement)||!(Se instanceof HTMLElement))return;let s=n.root.dataset.legendNotes??"Notes",c=n.root.dataset.legendTags??"Tags",l=n.root.dataset.legendMentions??"Mentions",d=n.root.dataset.inspectEmpty??"No direct connections";t.type==="tag"?(ge.textContent=c,fe.textContent=`#${t.tag}`,me.textContent=(n.root.dataset.previewTagTemplate??"{n} notes").replace("{n}",String(t.degree))):t.type==="mention"?(ge.textContent=l,fe.textContent=t.name,me.textContent=n.root.dataset.previewMention??"Mentioned, not published yet"):(ge.textContent=s,fe.textContent=t.name,me.textContent=t.excerpt);let f=t.tags.map(m=>{let k=document.createElement("li");return k.textContent=m,k});ve.replaceChildren(...f),ve.hidden=f.length===0;let y=vt(t).slice(0,12);if(y.length===0){let m=document.createElement("li");m.className="graph-landing__inspect-empty",m.textContent=d,Se.replaceChildren(m)}else Se.replaceChildren(...y.map(m=>{let k=document.createElement("li"),w=document.createElement("button");w.type="button",w.className="graph-landing__inspect-link",w.dataset.graphInspectId=m.id;let x=m.type==="tag"?c:m.type==="mention"?l:s,_=document.createElement("span");_.textContent=x;let $=document.createElement("strong");return $.textContent=m.type==="tag"?`#${m.tag}`:m.name,w.append(_,$),k.append(w),k}));j instanceof HTMLAnchorElement&&(t.type==="note"&&t.slug.length>0?(j.hidden=!1,j.href=kt(t.slug).toString()):(j.hidden=!0,j.removeAttribute("href"))),de.hidden=!1,n.root.dataset.inspecting="true",pe(!1),De()},he=()=>{T=null,de instanceof HTMLElement&&(de.hidden=!0),n.root.dataset.inspecting="false",Oe(!0),L(),n.use3d&&i()},Re=t=>{if(T===t.id&&t.type==="note"&&t.slug.length>0){mn(t.slug);return}T=t.id,St(t),L(),n.use3d&&i()},Fe=t=>{Re(t)},Ce=!1;e.onNodeClick((t,s)=>{t&&(Ce=!0,s&&typeof s.stopPropagation=="function"&&s.stopPropagation(),Fe(t))}),typeof e.onBackgroundClick=="function"&&e.onBackgroundClick(()=>{he()});let K=n.root.querySelector("#graph-landing-mount");if(K instanceof HTMLElement){let t=null,s=d=>{t={x:d.clientX,y:d.clientY}},c=(d,f)=>{if(typeof e.graph2ScreenCoords!="function")return null;let y=K.getBoundingClientRect(),m=d-y.left,k=f-y.top,w=null,x=4096;for(let _ of R().nodes){if(_.x===void 0||_.y===void 0)continue;let $=e.graph2ScreenCoords(_.x,_.y,_.z??0),Ct=($.x-m)**2+($.y-k)**2,xt=($.x-d)**2+($.y-f)**2,Ue=Math.min(Ct,xt);Ue<x&&(x=Ue,w=_)}return w},l=d=>{let f=t;if(t=null,!f)return;if((d.clientX-f.x)**2+(d.clientY-f.y)**2>25){Oe(!1);return}window.setTimeout(()=>{if(Ce){Ce=!1;return}let m=c(d.clientX,d.clientY);m?Fe(m):he()},0)};K.addEventListener("pointerdown",s,!0),K.addEventListener("pointerup",l,!0),window.addCleanup(()=>{K.removeEventListener("pointerdown",s,!0),K.removeEventListener("pointerup",l,!0)})}ct(n.root,"[data-graph-lens]",a.lens,"data-graph-lens"),N(),Ae(),a.lens!=="all"&&ae(),n.use3d||(typeof e.centerAt=="function"&&e.centerAt(0,0,0),typeof e.zoom=="function"&&e.zoom(1,0));let ze=()=>{o.current=ht(),e.backgroundColor(He()),n.bloomPass&&(n.bloomPass.strength=G()?We:0,n.bloomPass.radius=je,n.bloomPass.threshold=Ye),L(),i(),N()};document.addEventListener("themechange",ze),window.addCleanup(()=>document.removeEventListener("themechange",ze));let Be=t=>{let s=t.target;if(!(s instanceof Element))return;if(s.closest("[data-graph-inspect-close]")){he();return}if(s.closest("[data-graph-rail-toggle]")){pe(n.root.dataset.railOpen!=="true");return}if(s.closest("[data-graph-rail-scrim]")){pe(!1);return}let c=s.closest("[data-graph-inspect-id]");if(c instanceof HTMLElement&&c.dataset.graphInspectId){let k=r.nodes.find(w=>w.id===c.dataset.graphInspectId);k&&Re(k);return}let l=s.closest("[data-graph-lens]");if(l instanceof HTMLElement&&l.dataset.graphLens&&kn(l.dataset.graphLens)){wt(l.dataset.graphLens);return}let d=s.closest("[data-graph-tag]");if(d instanceof HTMLElement&&d.dataset.graphTag){Tt(d.dataset.graphTag);return}let f=s.closest("[data-graph-folder]");if(f instanceof HTMLElement&&f.dataset.graphFolder){Et(f.dataset.graphFolder);return}if(s.closest("[data-graph-relayout]")){e.d3ReheatSimulation();return}let y=s.closest("[data-graph-labels]");if(y instanceof HTMLButtonElement){a.allLabels=!a.allLabels,y.setAttribute("aria-pressed",a.allLabels?"true":"false");let k=y.dataset.labelShow??"Labels",w=y.dataset.labelHide??"Labels",x=a.allLabels?w:k;y.title=x,y.setAttribute("aria-label",x),i();return}if(s.closest("[data-graph-theme]")){let k=G()?"light":"dark";document.documentElement.setAttribute("saved-theme",k),localStorage.setItem("theme",k),document.body.classList.remove("theme-dark","theme-light"),document.body.classList.add(`theme-${k}`),document.dispatchEvent(new CustomEvent("themechange",{detail:{theme:k}}));return}let m=s.closest("[data-graph-tags-toggle]");if(m instanceof HTMLButtonElement){let k=n.root.querySelector(".graph-landing__tags");if(k instanceof HTMLElement){let w=k.dataset.open==="true";k.dataset.open=w?"false":"true",m.setAttribute("aria-expanded",w?"false":"true")}}},Y=n.root.querySelector("[data-graph-node-scale]"),X=n.root.querySelector("[data-graph-edge-scale]");if(Y instanceof HTMLInputElement){Y.value=String(Math.round(h.nodeScale*100));let t=()=>{h.nodeScale=Number(Y.value)/100,ye(h),L(),n.use3d&&i()};Y.addEventListener("input",t),window.addCleanup(()=>Y.removeEventListener("input",t))}if(X instanceof HTMLInputElement){X.value=String(Math.round(h.edgeScale*100));let t=()=>{h.edgeScale=Number(X.value)/100,ye(h),L()};X.addEventListener("input",t),window.addCleanup(()=>X.removeEventListener("input",t))}let Z=n.root.querySelector("[data-graph-zoom]");if(Z instanceof HTMLInputElement){Z.value=String(Math.round(h.zoom*100));let t=()=>{h.zoom=Number(Z.value)/100,ye(h),V(200)};Z.addEventListener("input",t),window.addCleanup(()=>Z.removeEventListener("input",t))}let J=n.root.querySelector("[data-graph-spread]");if(J instanceof HTMLInputElement){J.value=String(Math.round(h.spread*100));let t=()=>{h.spread=Number(J.value)/100,ye(h),E(),e.d3ReheatSimulation()};J.addEventListener("input",t),window.addCleanup(()=>J.removeEventListener("input",t))}n.root.addEventListener("click",Be),window.addCleanup(()=>n.root.removeEventListener("click",Be));let $e=t=>{if(t.key==="Escape"){if(n.root.dataset.railOpen==="true"){pe(!1);return}he()}};window.addEventListener("keydown",$e),window.addCleanup(()=>window.removeEventListener("keydown",$e))}async function Sn(){let e=document.querySelector(".graph-landing");if(!(e instanceof HTMLElement)||e.dataset.graphReady==="1")return;e.dataset.graphReady="1";let r=e.querySelector("#graph-landing-mount");if(!(r instanceof HTMLElement))throw new Error("graph-landing: mount element #graph-landing-mount is missing");let o=e.querySelectorAll("[data-graph-counts]"),n=e.dataset.locale??"ko",u=e.dataset.sourceLocale??"ko",a=(e.dataset.localePrefixes??"").split(",").map(E=>E.trim()).filter(E=>E.length>0),b=e.dataset.countsTemplate??"{n} nodes \\xB7 {m} edges",T=!1,h=null,v={current:ht()},A=()=>{T=!0,h&&(h._destructor(),h=null),delete e.dataset.graphReady};window.addCleanup(A);let M=un(),F=hn(M),H=M?import(Pt).then(E=>E.default??null).catch(E=>(console.error("[graph-landing] SpriteText unavailable; 3D hub labels disabled",E),null)):Promise.resolve(null),S=M?import(_t).catch(E=>(console.error("[graph-landing] three unavailable; using default node spheres",E),null)):Promise.resolve(null),U=M?import(It).then(E=>E.UnrealBloomPass?new E.UnrealBloomPass:null).catch(E=>(console.error("[graph-landing] UnrealBloomPass unavailable; dark-mode bloom disabled",E),null)):Promise.resolve(null);F.catch(()=>{});let D;try{D=Ge(await fetchData)}catch(E){throw it(r,"Graph could not load content index."),E}if(T)return;let P=an(Yt(D),{localeId:n,sourceLocale:u,prefixes:a}),O=b.replace("{n}",String(P.nodes.length)).replace("{m}",String(P.links.length));for(let E of o)E.textContent=O;let z;try{z=await F}catch(E){throw it(r,"Graph could not load. Check your network connection."),E}let[W,R,V]=await Promise.all([H,S,U]);T||(r.replaceChildren(),h=z(r),r.__graphLanding=h,r.__graphData=P,vn(h,P,v,{use3d:M,root:e,spriteText:W,bloomPass:V,three:R}))}var Cn="preferred-locale";document.addEventListener("click",e=>{let r=e.target;if(!(r instanceof Element))return;let o=r.closest("a[data-preferred-locale]");if(!(o instanceof HTMLAnchorElement))return;let n=o.dataset.preferredLocale;if(n)try{localStorage.setItem(Cn,n)}catch(u){console.error("[graph-landing] failed to persist preferred-locale",u)}});document.addEventListener("nav",()=>{Sn()});\n';
