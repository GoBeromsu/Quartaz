...
var graph_landing_inline_default = 'function st(e,r,o){let n=Number.isFinite(e)?Math.max(0,e):0,i=Number.isFinite(r)?Math.max(0,r):0,s=Number.isFinite(o)?Math.max(i,o):i;if(s===i)return i>0?.5:0;let h=Math.min(s,Math.max(i,n));return(Math.sqrt(h)-Math.sqrt(i))/(Math.sqrt(s)-Math.sqrt(i))}function It(e,r,o){return st(Math.max(e,r),0,o)}function Ue(e,r,o){return Number.isFinite(e)?Math.min(o,Math.max(r,e)):r}function At(e,r){let o=Ue(e,0,1),n=Ue(r,0,2);return Math.max(.5,1-o*.24*n)}function Pt(e,r){let o=Ue(e,0,1),n=Ue(r,0,2);return Math.min(1.6,1+o*.3*n)}var En=/^[A-Za-z0-9_-]{6,20}$/,xn=new Set(["youtube.com","www.youtube.com","music.youtube.com","m.youtube.com"]),Mn=new Set(["youtu.be","www.youtu.be"]);function Ve(e){return e&&En.test(e)?e:void 0}function Sn(e){if(!e)return;let r=e.trim(),o=Ve(r);if(o)return o;let n;try{n=new URL(r)}catch{return}if(!(n.protocol!=="https:"&&n.protocol!=="http:"||n.username||n.password||n.port)){if(xn.has(n.hostname)){if(n.pathname==="/watch")return Ve(n.searchParams.get("v"));let i=n.pathname.split("/").filter(Boolean);if(i.length===2&&(i[0]==="shorts"||i[0]==="embed"))return Ve(i[1])}if(Mn.has(n.hostname)){let i=n.pathname.split("/").filter(Boolean);if(i.length===1)return Ve(i[0])}}}function Dt(e){let r=[],o=new Set;for(let n of e){let i=n.title.trim(),s=Sn(n.url);if(!i||!s||o.has(s))continue;o.add(s);let h=n.artist?.trim();h?r.push({title:i,artist:h,videoId:s}):r.push({title:i,videoId:s})}return r}function D(e){return typeof e=="string"?e:e.id}function lt(e,r){return r===void 0||!Number.isFinite(r)||r<0?"full":e>=r?"dot":"full"}function $e(e,r,o){let n=e.get(r);if(n)return n;let i=o();return e.set(r,i),i}function ie(e,r){let o=e?r(e):void 0;return o!==void 0&&Number.isFinite(o)&&o>=0?o:void 0}function _t(e,r){if(r===void 0||!Number.isFinite(r)||r<0||r>=e.nodes.length)return e;let n=[...e.nodes].sort((h,x)=>x.degree!==h.degree?x.degree-h.degree:h.id<x.id?-1:h.id>x.id?1:0).slice(0,Math.max(0,r)),i=new Set(n.map(h=>h.id)),s=e.links.filter(h=>{let x=D(h.source),C=D(h.target);return i.has(x)&&i.has(C)});return{nodes:n,links:s}}function Gt(e,r,o,n){let i=new Set,s=Math.max(0,Math.floor(n));if(s<=0)return i;let h=new Set([o]),x=new Set([o]);for(let C=0;C<s;C+=1){let R=new Set;for(let Y of x)for(let y of e.get(Y)??[])h.has(y)||(h.add(y),R.add(y),r.has(y)||i.add(y));x=R}return i}var Cn=2.399963229728653,it=20;function Rt(e,r,o){let n=e.x??0,i=e.y??0,s=e.z??0,h=r*Cn;return{x:n+it*Math.cos(h),y:i+it*Math.sin(h),z:o?s+it*Math.sin(h*.5):s}}function Ht(e,r,o){let n=new Set;if(r!==null){n.add(r);for(let i of e.get(r)??[])n.add(i)}if(o!==null){n.add(o);for(let i of e.get(o)??[])n.add(i)}return n}var Xe="0.179.1",Nn="https://esm.sh/force-graph@1.51.4",In=`https://esm.sh/3d-force-graph@1.80.0?deps=three@${Xe}`,An=`https://esm.sh/three-spritetext@1.9.2?deps=three@${Xe}`,Pn=`https://esm.sh/three@${Xe}`,Dn=`https://esm.sh/three@${Xe}/examples/jsm/postprocessing/UnrealBloomPass.js`,_n=8,Gn=14;var Ie=1,yt=6,Rn=.05,Hn=2.6,Fn=1,Ft=1,Se=.18,on="graph-landing:lens",an="graph-landing:tune",wt="graph-landing:ambient-audio",Ot="UDVtMYqUAyw",Ce=12,On=28e3,zn="https://www.youtube.com/iframe_api",Bn=.18,zt=1.4,Vn=1.25,Un=1.15,$n=.55,Ae={x:330,y:235,z:565},Bt={x:0,y:0,z:0},Ye=Math.hypot(Ae.x,Ae.y,Ae.z),Wn=300/Ye,qn=1600/Ye,Vt=1.3,Yn=7.5,Ut=1.05,$t=.32,Wt=.28,Kn={wikilink:.3,tag:.22,external:.28,cooc:.16,folder:.16},jn="#a8b0c2",Xn="#2a3348",qt={min:80,max:200},Yt={min:40,max:110},Kt={min:160,max:280},jt={min:90,max:170},Xt=220,Zt=2,Zn=.15,Jn=.8,Qn=350,ct={min:-100,max:-190},ut={min:72,max:116},dt={min:130,max:260};function er(e){return Ke(e-.5,0,1)}function kt(e){if(e&&typeof e=="object")return e;throw new Error("graph-landing: expected an object in content index")}function ft(e){return Array.isArray(e)?e.filter(r=>typeof r=="string"):[]}function tr(e){let r=[];for(let o of Object.values(e)){let n=kt(o),i=typeof n.slug=="string"?n.slug:"";if(i.length===0)continue;let s=n.multilingual,h=s&&typeof s=="object"?s:void 0;r.push({slug:i,title:typeof n.title=="string"?n.title:i,links:ft(n.links),tags:ft(n.tags),externalLinks:ft(n.externalLinks),content:typeof n.content=="string"?n.content:"",multilingual:h})}return r}function nr(e){let r=e.replace(/\\s+/g," ").trim();return r.length<=Xt?r:`${r.slice(0,Xt).trimEnd()}\\u2026`}function Pe(e){let r=0;for(let o of e)r=r*31+o.charCodeAt(0)>>>0;return r%628/100}function Jt(e){return Pe(e)/(2*Math.PI)}function We(e,r,o){let n=Pe(e),i=Math.acos(2*Jt(`${e}:phi`)-1),s=r+(o-r)*Jt(`${e}:r`);return{x:s*Math.sin(i)*Math.cos(n),y:s*Math.sin(i)*Math.sin(n),z:s*Math.cos(i)}}function sn(e){return e==="index"||e.endsWith("/index")}function ln(e){return e==="tags"||e.startsWith("tags/")}function rr(e){let r=e.multilingual?.translationKey;if(r==="home"||r==="graph"||r==="about"||r==="writing")return!0;let o=e.slug;return o==="about"||o.endsWith("/about")||o.startsWith("inbox/")}function cn(e,r){for(let o of r){if(e===o)return{locale:o,permalink:""};if(e.startsWith(`${o}/`))return{locale:o,permalink:e.slice(o.length+1)}}return{locale:void 0,permalink:e}}function gt(e,r){return e.multilingual?.locale?e.multilingual.locale:cn(e.slug,r).locale}function or(e,r){return e.multilingual?.translationKey?`key:${e.multilingual.translationKey}`:`slug:${cn(e.slug,r).permalink}`}function ar(e,r){let o=e.find(n=>gt(n,r.prefixes)===r.localeId)??e.find(n=>gt(n,r.prefixes)===r.sourceLocale)??e.find(n=>gt(n,r.prefixes)===void 0);if(!o)throw new Error("graph-landing: locale group had no notes to pick");return o}function Ke(e,r,o){return Math.min(o,Math.max(r,e))}function Qt(e){let r=e.split("/").filter(o=>o.length>0);return r.length<2?"root":r[0]??"root"}function ir(e){let r=e.split("/").filter(o=>o.length>0);return r[r.length-1]??""}function vt(e){return ir(e).trim().toLowerCase()}function sr(e){return/^[a-z][a-z0-9+.-]*:/i.test(e)||e.startsWith("//")}function lr(e){let r=e.trim();return r.length===0||sr(r)||ln(r)||sn(r)?!0:vt(r).length===0}function cr(){let e=window.location.hostname.toLowerCase().replace(/^www\\./,""),r=[e,`www.${e}`,"beomsukoh.com","www.beomsukoh.com"];return[...new Set(r.filter(o=>o.length>0))]}function un(e){try{let r=new URL(e,window.location.origin);return r.protocol!=="http:"&&r.protocol!=="https:"?null:(r.hash="",r.hostname=r.hostname.toLowerCase(),r.pathname!=="/"&&r.pathname.endsWith("/")&&(r.pathname=r.pathname.replace(/\\/+$/,"")),r.toString())}catch{return null}}function ur(e,r){let o=un(e);return o===null?!1:!r.includes(new URL(o).hostname)}function en(e){return`external:${e}`}function dr(e,r){let o=new URL(e),n=o.hostname.replace(/^www\\./,""),i=o.pathname;return(r.get(n)??0)>1&&i.length>1?`${n}${i}`:n}function fr(e){let r=new Map,o=new Map;for(let n of e){let i=vt(n.slug);i.length>0&&!r.has(i)&&r.set(i,n.slug);let s=n.title.trim().toLowerCase();s.length>0&&!o.has(s)&&o.set(s,n.slug);let h=s.replace(/\\s+/g,"-");h.length>0&&!o.has(h)&&o.set(h,n.slug)}return{byBasename:r,byTitle:o}}function gr(e,r,o){if(r.has(e))return e;let n=vt(e),i=o.byBasename.get(n);if(i)return i;let s=o.byTitle.get(e.trim().toLowerCase())??o.byTitle.get(n);return s||null}function mr(e,r){return e.length===0?"":[...e].sort((n,i)=>(r.get(i)??0)-(r.get(n)??0))[0]??""}function pr(e,r,o=void 0){let n=e.filter(u=>!sn(u.slug)&&!ln(u.slug)&&!rr(u)),i=new Map;for(let u of n){let b=or(u,r.prefixes),w=i.get(b)??[];w.push(u),i.set(b,w)}let s=[];for(let u of i.values())s.push(ar(u,r));let h=new Set(s.map(u=>u.slug)),x=fr(s),C=new Map,R=[],Y=new Set,y=new Map,te=u=>{C.set(u,(C.get(u)??0)+1)},G=(u,b,w)=>u<b?`${u}|${b}|${w}`:`${b}|${u}|${w}`,M=(u,b,w,A)=>{let P=G(u,b,w);return Y.has(P)?!1:(Y.add(P),R.push({source:u,target:b,kind:w}),A&&(te(u),te(b)),!0)};for(let u of s)for(let b of u.links){if(lr(b))continue;let w=gr(b,h,x);w!==null&&w!==u.slug&&M(u.slug,w,"wikilink",!0)}let L=cr(),K=new Set;for(let u of s)for(let b of u.externalLinks){let w=un(b);w===null||!ur(w,L)||(K.add(w),M(u.slug,en(w),"external",!0))}let j=new Map;for(let u of K){let b=new URL(u).hostname.replace(/^www\\./,"");j.set(b,(j.get(b)??0)+1)}let H=new Set,z=new Map;for(let u of s)for(let b of u.tags){y.set(b,(y.get(b)??0)+1);let w=`tag:${b}`;H.add(w),M(u.slug,w,"tag",!0);let A=z.get(b)??[];A.push(u.slug),z.set(b,A)}if(o!==!1){let u=o?.maxTagsPerNote,b=o?.maxEdges,w=0;e:for(let A of s)if(!(A.tags.length<2)&&!(u!==void 0&&A.tags.length>u))for(let P=0;P<A.tags.length;P+=1)for(let _=P+1;_<A.tags.length;_+=1){if(b!==void 0&&w>=b)break e;M(`tag:${A.tags[P]}`,`tag:${A.tags[_]}`,"cooc",!1)&&(w+=1)}}let F=new Map;for(let u of s){let b=Qt(u.slug);if(b==="root")continue;let w=F.get(b)??[];w.push(u.slug),F.set(b,w)}for(let u of F.values()){if(u.length<2)continue;let b=[...u].sort();for(let w=0;w<b.length;w+=1){let A=b[(w+1)%b.length],P=b[(w+Zt)%b.length],_=b[w];_===void 0||A===void 0||(_!==A&&!Y.has(G(_,A,"wikilink"))&&M(_,A,"folder",!1),b.length>Zt+1&&P!==void 0&&_!==P&&!Y.has(G(_,P,"wikilink"))&&M(_,P,"folder",!1))}}let Q=[...C.values()],Z=Q.length>0?Math.min(...Q):0,J=Q.length>0?Math.max(...Q):0,V=u=>{let b=st(C.get(u)??0,Z,J);return Ie+b*(yt-Ie)},B=[...s].sort((u,b)=>(C.get(b.slug)??0)-(C.get(u.slug)??0)),W=new Set(B.filter(u=>(C.get(u.slug)??0)>0).slice(0,_n).map(u=>u.slug)),q=s.map(u=>{let b=W.has(u.slug),w=b?We(u.slug,Yt.min,Yt.max):We(u.slug,qt.min,qt.max);return{id:u.slug,name:u.title,type:"note",val:V(u.slug),degree:C.get(u.slug)??0,isHub:b,tag:"",slug:u.slug,url:"",folder:Qt(u.slug),tags:u.tags,dominantTag:mr(u.tags,y),excerpt:nr(u.content),phase:Pe(u.slug),x:w.x,y:w.y,z:w.z}});for(let u of K){let b=en(u),w=We(b,Kt.min,Kt.max);q.push({id:b,name:dr(u,j),type:"external",val:V(b)*$n,degree:C.get(b)??0,isHub:!1,tag:"",slug:"",url:u,folder:"",tags:[],dominantTag:"",excerpt:u,phase:Pe(b),x:w.x,y:w.y,z:w.z})}for(let u of H){let b=u.slice(4),w=We(u,jt.min,jt.max);q.push({id:u,name:b,type:"tag",val:Ke(V(u)*.7,Ie,yt),degree:C.get(u)??0,isHub:!1,tag:b,slug:`tags/${b}`,url:"",folder:"tag",tags:[b],dominantTag:b,excerpt:"",phase:Pe(u),x:w.x,y:w.y,z:w.z})}return{nodes:q,links:R}}function mt(e){let r=new Map,o=(n,i)=>{let s=r.get(n)??new Set;s.add(i),r.set(n,s)};for(let n of e){if(n.kind!=="wikilink"&&n.kind!=="tag"&&n.kind!=="external")continue;let i=D(n.source),s=D(n.target);o(i,s),o(s,i)}return r}function he(e,r){let o=document.createElement("span");o.style.color=`var(${e})`,o.style.position="absolute",o.style.visibility="hidden",document.body.appendChild(o);let n=getComputedStyle(o).color;return o.remove(),n||r}function dn(){let e=getComputedStyle(document.documentElement).getPropertyValue("--bodyFont").trim();return{bg:he("--light","#ffffff"),ink:he("--darkgray","#0f0f0f"),accent:he("--secondary","#a52142"),tertiary:he("--tertiary","#c75b75"),gray:he("--gray","#737373"),external:he("--graph-external","#3f6f8c"),font:e.length>0?e:"Inter, sans-serif"}}function qe(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function hr(){let e=document.createElement("canvas");return(e.getContext("webgl")??e.getContext("experimental-webgl"))!==null}function br(){return hr()&&!qe()}function X(){return document.documentElement.getAttribute("saved-theme")==="dark"}function je(e){let r=e.match(/rgba?\\(\\s*(\\d+)\\s*,\\s*(\\d+)\\s*,\\s*(\\d+)/);if(r&&r[1]&&r[2]&&r[3])return{r:Number(r[1]),g:Number(r[2]),b:Number(r[3])};let o=e.match(/^#([0-9a-f]{6})$/i);if(o&&o[1]){let n=parseInt(o[1],16);return{r:n>>16&255,g:n>>8&255,b:n&255}}return null}function be(e,r){let o=je(e);return o?`rgba(${o.r}, ${o.g}, ${o.b}, ${r})`:e}function le(e,r,o){let n=je(e),i=je(r);if(!n||!i)return e;let s=(h,x)=>Math.round(h+(x-h)*o);return`rgb(${s(n.r,i.r)}, ${s(n.g,i.g)}, ${s(n.b,i.b)})`}function fn(e){return X()?le(e.bg,"#05070f",.88):e.bg}function yr(e){let r=je(e);if(!r)return e;let o=n=>{let i=n/255,s=i<=.04045?i/12.92:Math.pow((i+.055)/1.055,2.4);return Math.round(s*255)};return`rgb(${o(r.r)}, ${o(r.g)}, ${o(r.b)})`}function wr(e){return yr(fn(e))}function gn(e,r){let o=0;for(let n of e)o=o*31+n.charCodeAt(0)>>>0;return r[o%r.length]??r[0]??e}function tn(e,r){return e==="articles"?r.accent:e==="inbox"?r.tertiary:e==="root"?r.ink:gn(e,[r.accent,r.tertiary,r.ink,r.gray])}function kr(e,r){return e.length===0?r.ink:gn(e,[r.accent,r.tertiary])}function mn(e){let r=e.split("/").map(s=>encodeURIComponent(s)).join("/"),o=document.querySelector("base")?.getAttribute("href"),n="/";o&&o.startsWith("/")&&!o.startsWith("//")&&(n=o.endsWith("/")?o:`${o}/`);let i=`${n}${r}`.replace(/\\/{2,}/g,"/");return new URL(i,window.location.origin)}function vr(e){if(e.length===0)throw new Error("graph-landing: cannot navigate a node without a slug");let r=mn(e);window.location.assign(r.toString())}function Tr(e){if(e.length===0)throw new Error("graph-landing: cannot open an empty external url");window.open(e,"_blank","noopener,noreferrer")}function Lr(e){let r=e.default;if(typeof r!="function")throw new Error("graph-landing: CDN module did not export a graph factory");return r()}function pt(e,r){e.textContent=r,e.classList.add("graph-landing__error")}async function Er(e){let o=await import(e?In:Nn);return e&&typeof o.default=="function"?o.default({controlType:"orbit"}):Lr(o)}function xr(){try{let e=sessionStorage.getItem(on);if(e==="hub")return"all";if(e==="all"||e==="tag"||e==="folder")return e}catch(e){console.error("[graph-landing] sessionStorage unavailable for lens persistence",e)}return"all"}function Mr(){let e={nodeScale:.7,edgeScale:1,zoom:1,spread:1,hubGravity:1};try{let r=sessionStorage.getItem(an);if(!r)return e;let o=kt(JSON.parse(r)),n=typeof o.nodeScale=="number"?o.nodeScale:e.nodeScale,i=typeof o.edgeScale=="number"?o.edgeScale:e.edgeScale,s=typeof o.zoom=="number"?o.zoom:e.zoom,h=typeof o.spread=="number"?o.spread:e.spread,x=typeof o.hubGravity=="number"&&Number.isFinite(o.hubGravity)?Math.min(2,Math.max(0,o.hubGravity)):e.hubGravity;return{nodeScale:n,edgeScale:i,zoom:s,spread:h,hubGravity:x}}catch(r){return console.error("[graph-landing] sessionStorage unavailable for tune persistence",r),e}}function Ne(e){try{sessionStorage.setItem(an,JSON.stringify(e))}catch(r){console.error("[graph-landing] could not persist tune",r)}}function ht(e){try{sessionStorage.setItem(on,e)}catch(r){console.error("[graph-landing] could not persist lens",r)}}function Sr(e){return e==="all"||e==="tag"||e==="folder"||e==="hub"}function Cr(e,r){return e.type==="tag"?e.tag===r:e.tags.includes(r)}function Nr(e,r){return e.type==="note"&&e.folder===r}function nn(e,r){let o=D(r),n=e.find(i=>i.id===o);return!n||n.type!=="note"?null:n.folder}function Ir(e,r,o){let n=new Map;if(r==="folder"){let i=[...new Set(e.nodes.filter(s=>s.type==="note").map(s=>s.folder))];return i.forEach((s,h)=>{let x=Math.PI*2*h/Math.max(i.length,1),C={x:Math.cos(x)*o,y:Math.sin(x)*o,z:0};for(let R of e.nodes)R.type==="note"&&R.folder===s&&n.set(R.id,C)}),n}if(r==="tag"){let i=e.nodes.filter(h=>h.type==="tag"),s=new Map;i.forEach((h,x)=>{let C=Math.PI*2*x/Math.max(i.length,1);s.set(h.tag,{x:Math.cos(C)*o,y:Math.sin(C)*o,z:0})});for(let h of e.nodes)if(h.type==="tag"){let x=s.get(h.tag);x&&n.set(h.id,x)}else if(h.dominantTag.length>0){let x=s.get(h.dominantTag);x&&n.set(h.id,x)}}return n}function Ar(e,r){let o=[],n=i=>{let s=r*i;for(let h of o){let x=e(h);x&&(h.vx=(h.vx??0)+(x.x-(h.x??0))*s,h.vy=(h.vy??0)+(x.y-(h.y??0))*s,h.vz=(h.vz??0)+(x.z-(h.z??0))*s)}};return n.initialize=i=>{o=i},n}function rn(e,r,o,n){for(let i of e.querySelectorAll(r)){if(!(i instanceof HTMLElement))continue;let s=i.getAttribute(n);i.setAttribute("aria-pressed",s===o?"true":"false")}}function Pr(e,r,o,n){let i=mt(r.links),s=(t,a,l)=>t<a?`${t}|${a}|${l}`:`${a}|${t}|${l}`,h=new Map,x=new Map,C=new Set,R=new Set;n.fullData!==r&&(h=new Map(n.fullData.nodes.map(t=>[t.id,t])),x=mt(n.fullData.links),C=new Set(r.nodes.map(t=>t.id)),R=new Set(r.links.map(t=>s(D(t.source),D(t.target),t.kind))));let Y=t=>{if(n.fullData===r)return!1;let a=Gt(x,C,t,n.expandHops);if(a.size===0)return!1;let l=n.layout.incrementalWarmup?h.get(t):void 0,d=0;for(let f of a){let c=h.get(f);if(c){if(l&&c.x===void 0){let m=Rt(l,d,n.use3d);c.x=m.x,c.y=m.y,c.z=m.z,d+=1}r.nodes.push(c),C.add(f)}}for(let f of n.fullData.links){let c=D(f.source),m=D(f.target);if(!C.has(c)||!C.has(m))continue;let g=s(c,m,f.kind);R.has(g)||(R.add(g),r.links.push(f))}return i=mt(r.links),!0},y={lens:xr(),allLabels:!1,focusTag:null,focusFolder:null},te=null,G=null,M=Mr(),L=()=>G??te,K=new Set(r.nodes.filter(t=>t.type==="note").sort((t,a)=>a.degree-t.degree).slice(0,Gn).map(t=>t.id)),j=t=>{let a=t.val;return t.isHub&&(a*=zt),y.lens==="tag"&&t.type==="tag"&&(a*=Vn),y.focusTag&&t.id===`tag:${y.focusTag}`&&(a*=Un),a},H=t=>{let a=L();return y.allLabels||a===t.id||a!==null&&(i.get(a)?.has(t.id)??!1)?!0:K.has(t.id)},z=t=>{let a=yt*zt,l=Ke((j(t)-Ie)/(a-Ie),0,1);return(Vt+l*(Yn-Vt))*M.nodeScale},F=t=>{let a=L();if(a!==null)return a===t||(i.get(a)?.has(t)??!1);if(y.focusTag===null&&y.focusFolder===null)return!0;let l=r.nodes.find(d=>d.id===t);return l?y.focusFolder!==null?Nr(l,y.focusFolder):y.focusTag!==null&&Cr(l,y.focusTag):!1},Q=t=>t.type==="external"?o.current.external:y.lens==="tag"?t.type==="tag"?o.current.tertiary:kr(t.dominantTag,o.current):y.lens==="folder"?t.type==="tag"?o.current.tertiary:tn(t.folder,o.current):y.lens==="hub"?t.type==="tag"?o.current.tertiary:t.isHub?o.current.accent:o.current.ink:t.type==="tag"?o.current.tertiary:o.current.ink,Z=t=>{let a=L();if(a!==null&&(a===t.id||(i.get(a)?.has(t.id)??!1)))return o.current.accent;let l=Q(t);return F(t.id)?X()?t.type==="external"?le(o.current.external,"#ffffff",.18):t.type==="tag"?le(o.current.tertiary,"#ffffff",.22):t.isHub?le("#fff3e4",o.current.accent,.1):le("#ffffff",o.current.accent,.12):t.type==="external"?le(o.current.external,"#08343a",.12):t.type==="tag"?le(o.current.tertiary,o.current.accent,.55):t.isHub?le(o.current.ink,o.current.accent,.22):l:be(l,Se)},J=t=>{let a=X();return t==="wikilink"?a?.34:.52:t==="external"?a?.3:.44:t==="tag"?a?.22:.32:a?.12:.2},V=t=>{let a=D(t.source),l=D(t.target),d=L();return d!==null&&(a===d||l===d)?X()?.72:.78:(d!==null||y.focusTag!==null||y.focusFolder!==null)&&(!F(a)||!F(l))?J(t.kind)*Se:J(t.kind)},B=t=>{let a=D(t.source),l=D(t.target),d=L(),f=X()?jn:Xn;return d!==null&&(a===d||l===d)?le(o.current.accent,f,.45):f},W=t=>be(B(t),V(t)),q=()=>r,u=t=>{let a=X()?"rgba(255, 255, 255, 1)":be(o.current.ink,.88);return F(t.id)?a:be(a,Se)},b=t=>X()?F(t.id)?"rgba(0, 0, 0, 0.95)":"rgba(0, 0, 0, 0.3)":"rgba(0, 0, 0, 0)",w=()=>{if(typeof e.cameraPosition=="function"){let t=e.cameraPosition();if(t&&typeof t.x=="number"&&typeof t.y=="number"&&typeof t.z=="number"){let a=Math.hypot(t.x,t.y,t.z);if(a>1)return{dir:{x:t.x,y:t.y,z:t.z},len:a}}}return{dir:Ae,len:Ye}},A=t=>{if(n.use3d){if(typeof e.cameraPosition!="function")return;let a=Ye/Ke(M.zoom,.4,2.5),{dir:l,len:d}=w(),f=a/d;e.cameraPosition({x:l.x*f,y:l.y*f,z:l.z*f},Bt,t),et();return}typeof e.zoom=="function"&&e.zoom(M.zoom,t)},P=()=>{let t=er(M.spread),a=ct.min+t*(ct.max-ct.min),l=ut.min+t*(ut.max-ut.min),d=new Map(r.nodes.map(S=>[S.id,S.degree])),f=Math.max(0,...d.values()),c=S=>It(d.get(D(S.source))??0,d.get(D(S.target))??0,f),m=e.d3Force("charge");m?.strength&&m.strength(a),m?.theta&&n.layout.chargeTheta!==void 0&&m.theta(n.layout.chargeTheta);let g=e.d3Force("link");g?.distance&&g.distance(S=>{let O=At(c(S),M.hubGravity);return y.lens==="tag"&&S.kind==="tag"?l*.72*O:S.kind==="cooc"||S.kind==="folder"?l:l*O}),g?.strength&&g.strength(S=>{if(S.kind==="cooc"||S.kind==="folder")return .04;let O=Pt(c(S),M.hubGravity);if(y.lens==="tag"&&S.kind==="tag")return Math.min(1,.95*O);if(y.lens==="folder"){let de=nn(r.nodes,S.source),at=nn(r.nodes,S.target);if(de!==null&&de===at)return Math.min(1,.72*O)}return S.kind==="tag"?Math.min(1,.65*O):Math.min(1,.8*O)});let p=e.d3Force("center");p?.strength&&p.strength(Rn);let T=dt.min+t*(dt.max-dt.min),v=Ir(r,y.lens,T),$=y.lens==="folder"||y.lens==="tag"?.08:0;e.d3Force("cluster",Ar(S=>v.get(S.id)??null,$)),n.use3d&&e.d3Force("flattenZ",null)},_=new Map,ne=new Map,re=new Map,oe=new Map,ee=new Map,se=new Map,ce=new Map,k=(t,a,l)=>{let d=`${Math.round(a*4)}|${l}`;return $e(ce,d,()=>({geometry:new t.SphereGeometry(a,6,6),material:new t.MeshBasicMaterial({color:l})}))},N=new Map,I=new Map,E=(t,a,l)=>{let d=`${a}|${l}`;return $e(N,d,()=>new t.CylinderGeometry(a,a,1,l))},fe=(t,a,l)=>{let d=`${a}|${l}`;return $e(I,d,()=>new t.MeshBasicMaterial({color:a,transparent:!0,opacity:l,depthWrite:!1}))},ae=()=>{if(!n.use3d||typeof e.nodeThreeObject!="function")return;let t=n.spriteText,a=n.three,l=n.lod.dotDistance,d=n.lod.nodeResolution??14,f=n.interaction.incrementalRepaint;if(_.clear(),ne.clear(),ce.clear(),oe.clear(),ee.clear(),f)for(let c of r.nodes)ee.set(c.id,c);typeof e.nodeThreeObjectExtend=="function"&&e.nodeThreeObjectExtend(a===null),e.nodeThreeObject(c=>{let m=z(c),g=Z(c),p=!1;if(a){if(X()){let S=c.isHub?1.35:1.1,O=new a.MeshLambertMaterial({color:g,emissive:g,emissiveIntensity:S});_.set(c.id,{material:O,base:S,phase:c.phase}),f&&oe.set(c.id,O),p=new a.Mesh(new a.SphereGeometry(m,d,d),O)}else{let S=new a.MeshBasicMaterial({color:g});f&&oe.set(c.id,S),p=new a.Mesh(new a.SphereGeometry(m,d,d),S)}if(l!==void 0&&p!==!1){let S=k(a,m,g),O=new a.Mesh(S.geometry,S.material),de=new a.LOD;de.addLevel(p,0),de.addLevel(O,l),p=de}}let T=H(c);if(!t||!f&&!T)return p;let v=new t(c.name);if(v.color=u(c),v.backgroundColor=!1,v.fontWeight="400",v.strokeWidth=X()?.35:0,v.strokeColor=b(c),v.material.transparent=!0,v.material.depthWrite=!1,v.material.alphaTest=.01,v.material.toneMapped=!1,v.textHeight=K.has(c.id)?6.5:5.5,v.center.set(0,.5),v.position.x=m+2,v.position.y=0,f?(v.visible=T,ne.set(c.id,{sprite:v,node:c})):n.lod.labelDistance!==void 0&&ne.set(c.id,{sprite:v,node:c}),!a||p===!1)return v;let $=new a.Group;return $.add(p),$.add(v),$})},ye=()=>{let t=n.three;if(!n.use3d||!t||typeof e.linkThreeObject!="function")return;let a=new t.Vector3(0,1,0),l=n.lod.linkResolution??5,d=n.lod.cullDistance,f=n.interaction.incrementalRepaint,c=n.lod.shareLinkResources;if(re.clear(),se.clear(),N.clear(),I.clear(),f)for(let m of r.links){let g=D(m.source),p=D(m.target);for(let T of[g,p]){let v=se.get(T);v?v.push(m):se.set(T,[m])}}e.linkThreeObject(m=>{let g=Kn[m.kind]*M.edgeScale,p=c?fe(t,B(m),V(m)):new t.MeshBasicMaterial({color:B(m),transparent:!0,opacity:V(m),depthWrite:!1}),T=c?E(t,g,l):new t.CylinderGeometry(g,g,1,l),v=new t.Mesh(T,p);return(d!==void 0||f)&&re.set(m,v),v}),typeof e.linkPositionUpdate=="function"&&e.linkPositionUpdate((m,g)=>{let p=g.end.x-g.start.x,T=g.end.y-g.start.y,v=g.end.z-g.start.z,$=Math.sqrt(p*p+T*T+v*v);return m.position.x=(g.start.x+g.end.x)/2,m.position.y=(g.start.y+g.end.y)/2,m.position.z=(g.start.z+g.end.z)/2,m.scale.x=1,m.scale.y=Math.max($,.01),m.scale.z=1,m.quaternion.setFromUnitVectors(a,new t.Vector3(p,T,v).normalize()),!0})},Tt=()=>{!n.use3d||typeof e.linkDirectionalParticles!="function"||e.linkDirectionalParticles(t=>{let a=L();if(a===null)return 0;let l=D(t.source),d=D(t.target);return l===a||d===a?2:0})},ge=()=>{e.nodeVal(j),e.nodeColor(Z),e.linkColor(W),e.linkWidth(t=>{let a=D(t.source),l=D(t.target),d=L(),f=M.edgeScale;return d!==null&&(a===d||l===d)?.7*f:t.kind==="wikilink"||t.kind==="external"?.5*f:(t.kind==="tag"?.35:.25)*f}),typeof e.linkOpacity=="function"&&e.linkOpacity(Ft),Tt(),ye(),n.use3d||e.nodeCanvasObjectMode(()=>"replace")},pn=(t,a)=>{let l=Ht(i,t,a),d=new Set;for(let f of l){let c=ee.get(f);if(!c)continue;let m=Z(c);oe.get(f)?.color.set(m);let g=_.get(f);g&&g.material.emissive.set(m);let p=ne.get(f);p&&(p.sprite.color=u(c),p.sprite.strokeColor=b(c),p.sprite.strokeWidth=X()?.35:0,p.sprite.visible=H(c));for(let T of se.get(f)??[]){if(d.has(T))continue;d.add(T);let v=re.get(T);v&&(n.lod.shareLinkResources&&n.three?v.material=fe(n.three,B(T),V(T)):(v.material.color.set(B(T)),v.material.opacity=V(T)))}}},Ze=t=>{if(n.interaction.incrementalRepaint&&n.use3d){Tt(),pn(t,L());return}ge(),n.use3d&&ae()},Je=()=>{let t=n.root.querySelector("[data-graph-legend]");if(!(t instanceof HTMLElement))return;let a=(c,m)=>{let g=document.createElement("span");g.className="graph-landing__legend-item";let p=document.createElement("span");p.className="graph-landing__dot",p.setAttribute("aria-hidden","true"),p.style.background=c;let T=document.createElement("span");return T.textContent=m,g.append(p,T),g},l=n.root.dataset.legendNotes??"Notes",d=n.root.dataset.legendTags??"Tags",f=n.root.dataset.legendLinks??"Links";t.replaceChildren(a(o.current.ink,l),a(o.current.tertiary,d),a(o.current.external,f))},Lt=t=>{let a=document.createElement("li"),l=document.createElement("button");l.type="button",l.className="graph-landing__tag-item",l.dataset[t.dataset.key]=t.dataset.value,l.setAttribute("aria-pressed",t.pressed?"true":"false");let d=document.createElement("span");if(d.className="graph-landing__facet-name",t.dotColor!==null){let c=document.createElement("span");c.className="graph-landing__dot",c.style.background=t.dotColor,d.append(c)}d.append(document.createTextNode(t.label));let f=document.createElement("span");return f.className="graph-landing__tag-count",f.textContent=String(t.count),l.append(d,f),a.append(l),a},Et=()=>{let t=n.root.querySelector("[data-graph-tags]");if(!(t instanceof HTMLElement))return;let a=n.root.querySelector("[data-graph-facet-label]"),l=n.root.querySelector(".graph-landing__tags");if(y.lens==="folder"){let f=n.root.dataset.folderRootLabel??"root",c=new Map;for(let g of r.nodes)g.type==="note"&&c.set(g.folder,(c.get(g.folder)??0)+1);let m=[...c.entries()].sort((g,p)=>p[1]-g[1]);a instanceof HTMLElement&&(a.textContent=n.root.dataset.legendFolders??"Folders"),l instanceof HTMLElement&&(l.hidden=m.length===0),t.replaceChildren(...m.map(([g,p])=>Lt({dataset:{key:"graphFolder",value:g},pressed:y.focusFolder===g,dotColor:tn(g,o.current),label:g==="root"?f:g,count:p})));return}let d=r.nodes.filter(f=>f.type==="tag").sort((f,c)=>c.degree-f.degree).slice(0,16);a instanceof HTMLElement&&(a.textContent=n.root.dataset.legendTags??"Tags"),l instanceof HTMLElement&&(l.hidden=d.length===0),t.replaceChildren(...d.map(f=>Lt({dataset:{key:"graphTag",value:f.tag},pressed:y.focusTag===f.tag,dotColor:null,label:f.tag,count:f.degree})))},we=null;n.layout.incrementalWarmup&&typeof e.onFinishUpdate=="function"&&e.onFinishUpdate(()=>{we!==null&&(e.warmupTicks(we),we=null)});let hn=()=>{!n.layout.incrementalWarmup||typeof e.onFinishUpdate!="function"||(we===null&&(we=e.warmupTicks()),e.warmupTicks(0))},ke=()=>{e.graphData(q()),P(),ge(),ae(),Je(),Et(),rn(n.root,"[data-graph-lens]",y.lens,"data-graph-lens"),e.d3ReheatSimulation()},bn=t=>{y.lens=t,t!=="tag"&&(y.focusTag=null),t!=="folder"&&(y.focusFolder=null),ht(t),ke()},yn=t=>{y.focusTag=y.focusTag===t?null:t,y.focusFolder=null,y.focusTag&&(y.lens="tag",ht("tag")),ke()},wn=t=>{y.focusFolder=y.focusFolder===t?null:t,y.focusTag=null,y.focusFolder&&(y.lens="folder",ht("folder")),ke()},Qe=()=>n.use3d?wr(o.current):fn(o.current),et=()=>{if(!n.use3d||!n.lod.fog||!n.three||typeof e.scene!="function")return;let t=w().len;e.scene().fog=new n.three.Fog(Qe(),t*Wn,t*qn)};e.graphData(q()),e.backgroundColor(Qe()),e.nodeLabel(t=>t.name),e.nodeRelSize(Hn),typeof e.nodeOpacity=="function"&&e.nodeOpacity(Fn),typeof e.linkOpacity=="function"&&e.linkOpacity(Ft),P(),ge();let me=n.root.querySelector("[data-graph-preview]"),De=n.root.querySelector("[data-graph-preview-chip]"),_e=n.root.querySelector("[data-graph-preview-title]"),Ge=n.root.querySelector("[data-graph-preview-excerpt]"),Re=0;window.addCleanup(()=>window.clearTimeout(Re));let kn=t=>{if(!(me instanceof HTMLElement)||!(De instanceof HTMLElement)||!(_e instanceof HTMLElement)||!(Ge instanceof HTMLElement))return;window.clearTimeout(Re);let a=n.root.dataset.legendNotes??"Notes",l=n.root.dataset.legendTags??"Tags",d=n.root.dataset.legendLinks??"Links";if(t.type==="tag"){let f=n.root.dataset.previewTagTemplate??"{n} notes";De.textContent=l,_e.textContent=`#${t.tag}`,Ge.textContent=f.replace("{n}",String(t.degree))}else t.type==="external"?(De.textContent=d,_e.textContent=t.name,Ge.textContent=t.url):(De.textContent=a,_e.textContent=t.name,Ge.textContent=t.excerpt);me.hidden=!1,me.dataset.visible="true"},xt=()=>{me instanceof HTMLElement&&(window.clearTimeout(Re),Re=window.setTimeout(()=>{me.dataset.visible="false",me.hidden=!0},Qn))};if(e.onNodeHover(t=>{let a=L();te=t?t.id:null,G===null&&(t?kn(t):xt()),Ze(a)}),n.use3d){if(typeof e.showNavInfo=="function"&&e.showNavInfo(!1),typeof e.enableNavigationControls=="function"&&e.enableNavigationControls(!0),!qe()&&typeof e.controls=="function"){let l=e.controls();l.autoRotate=!1,l.autoRotateSpeed=Bn;let d=window.setTimeout(()=>{typeof e.controls=="function"&&(e.controls().autoRotate=!0)},1600);window.addCleanup(()=>window.clearTimeout(d))}if(e.warmupTicks(n.layout.warmupTicks??50),e.cooldownTicks(n.layout.freezeAfterWarmup?0:n.layout.cooldownTicks??200),typeof e.linkDirectionalParticleWidth=="function"&&e.linkDirectionalParticleWidth(1.1),typeof e.linkDirectionalParticleSpeed=="function"&&e.linkDirectionalParticleSpeed(.004),typeof e.linkDirectionalParticleColor=="function"&&e.linkDirectionalParticleColor(()=>o.current.accent),n.bloomPass&&typeof e.postProcessingComposer=="function"&&(n.bloomPass.strength=X()?Ut:0,n.bloomPass.radius=$t,n.bloomPass.threshold=Wt,e.postProcessingComposer().addPass(n.bloomPass)),typeof e.cameraPosition=="function"&&(e.cameraPosition(Ae,Bt),M.zoom!==1&&A(0)),ae(),et(),!qe()){let l=0,d=()=>{let f=performance.now()/1e3*Jn;for(let c of _.values())c.material.emissiveIntensity=c.base*(1+Zn*Math.sin(f+c.phase));l=window.requestAnimationFrame(d)};l=window.requestAnimationFrame(d),window.addCleanup(()=>window.cancelAnimationFrame(l))}let t=n.lod.labelDistance,a=n.lod.cullDistance;if((t!==void 0||a!==void 0)&&typeof e.cameraPosition=="function"){let l=e.cameraPosition.bind(e),d=0,f=()=>{let c=l();if(c&&typeof c.x=="number"&&typeof c.y=="number"&&typeof c.z=="number"){if(t!==void 0)for(let m of ne.values()){let g=m.node.x??0,p=m.node.y??0,T=m.node.z??0,v=Math.hypot(c.x-g,c.y-p,c.z-T);m.sprite.visible=lt(v,t)==="full"}if(a!==void 0){let m=L();for(let[g,p]of re){let T=D(g.source),v=D(g.target);if(m!==null&&(T===m||v===m)){p.visible=!0;continue}let $=Math.hypot(c.x-p.position.x,c.y-p.position.y,c.z-p.position.z);p.visible=lt($,a)!=="dot"}}}d=window.requestAnimationFrame(f)};d=window.requestAnimationFrame(f),window.addCleanup(()=>window.cancelAnimationFrame(d))}}else e.warmupTicks(n.layout.warmupTicks??60),e.cooldownTicks(n.layout.freezeAfterWarmup?0:n.layout.cooldownTicks??180),e.nodeCanvasObject((t,a,l)=>{let d=z(t),f=t.x??0,c=t.y??0;if(a.save(),a.beginPath(),a.arc(f,c,d,0,Math.PI*2),a.fillStyle=Z(t),a.fill(),t.isHub&&(a.strokeStyle=F(t.id)?o.current.accent:be(o.current.accent,Se),a.lineWidth=1.2/l,a.stroke()),H(t)){let m=11.5/l;a.font=`${m}px ${o.current.font}`,a.fillStyle=F(t.id)?o.current.ink:be(o.current.ink,Se),a.textAlign="center",a.textBaseline="bottom",a.fillText(t.name,f,c-d-6)}a.restore()}),typeof e.nodePointerAreaPaint=="function"&&e.nodePointerAreaPaint((t,a,l)=>{let d=z(t)+8;l.beginPath(),l.arc(t.x??0,t.y??0,d,0,Math.PI*2),l.fillStyle=a,l.fill()});let He=n.root.querySelector("[data-graph-inspect]"),Fe=n.root.querySelector("[data-graph-inspect-chip]"),Oe=n.root.querySelector("[data-graph-inspect-title]"),ze=n.root.querySelector("[data-graph-inspect-excerpt]"),tt=n.root.querySelector("[data-graph-inspect-tags]"),nt=n.root.querySelector("[data-graph-inspect-connected]"),U=n.root.querySelector("[data-graph-inspect-open]"),pe=t=>{n.root.dataset.railOpen=t?"true":"false";let a=n.root.querySelector("[data-graph-rail-toggle]"),l=n.root.querySelector("[data-graph-rail-scrim]"),d=n.root.querySelector("#graph-landing-rail");a instanceof HTMLButtonElement&&a.setAttribute("aria-expanded",t?"true":"false"),d instanceof HTMLElement&&d.setAttribute("aria-hidden",t?"false":"true"),l instanceof HTMLElement&&(l.hidden=!t)},Be=t=>{qe()||typeof e.controls!="function"||(e.controls().autoRotate=t)},vn=t=>{let a=i.get(t.id)??new Set,l=[];for(let d of a){let f=r.nodes.find(c=>c.id===d);f&&l.push(f)}return l.sort((d,f)=>f.degree-d.degree)},Tn=t=>{if(!(He instanceof HTMLElement)||!(Fe instanceof HTMLElement)||!(Oe instanceof HTMLElement)||!(ze instanceof HTMLElement)||!(tt instanceof HTMLElement)||!(nt instanceof HTMLElement))return;let a=n.root.dataset.legendNotes??"Notes",l=n.root.dataset.legendTags??"Tags",d=n.root.dataset.legendLinks??"Links",f=n.root.dataset.inspectEmpty??"No direct connections";t.type==="tag"?(Fe.textContent=l,Oe.textContent=`#${t.tag}`,ze.textContent=(n.root.dataset.previewTagTemplate??"{n} notes").replace("{n}",String(t.degree))):t.type==="external"?(Fe.textContent=d,Oe.textContent=t.name,ze.textContent=t.url):(Fe.textContent=a,Oe.textContent=t.name,ze.textContent=t.excerpt);let c=t.tags.map(g=>{let p=document.createElement("li");return p.textContent=g,p});tt.replaceChildren(...c),tt.hidden=c.length===0;let m=vn(t).slice(0,12);if(m.length===0){let g=document.createElement("li");g.className="graph-landing__inspect-empty",g.textContent=f,nt.replaceChildren(g)}else nt.replaceChildren(...m.map(g=>{let p=document.createElement("li"),T=document.createElement("button");T.type="button",T.className="graph-landing__inspect-link",T.dataset.graphInspectId=g.id;let v=g.type==="tag"?l:g.type==="external"?d:a,$=document.createElement("span");$.textContent=v;let S=document.createElement("strong");return S.textContent=g.type==="tag"?`#${g.tag}`:g.name,T.append($,S),p.append(T),p}));U instanceof HTMLAnchorElement&&(t.type==="note"&&t.slug.length>0?(U.hidden=!1,U.href=mn(t.slug).toString(),U.textContent=n.root.dataset.inspectRead??"Read note",U.removeAttribute("target"),U.removeAttribute("rel")):t.type==="external"&&t.url.length>0?(U.hidden=!1,U.href=t.url,U.textContent=n.root.dataset.inspectOpenExternal??"Open",U.target="_blank",U.rel="noopener noreferrer"):(U.hidden=!0,U.removeAttribute("href"),U.removeAttribute("target"),U.removeAttribute("rel"))),He.hidden=!1,n.root.dataset.inspecting="true",pe(!1),xt()},ve=()=>{let t=L();G=null,He instanceof HTMLElement&&(He.hidden=!0),n.root.dataset.inspecting="false",Be(!0),Ze(t)},Ln=t=>{if(G===t.id&&t.type==="note"&&t.slug.length>0){vr(t.slug);return}if(G===t.id&&t.type==="external"&&t.url.length>0){Tr(t.url);return}let a=L();G=t.id,Tn(t),Ze(a)},rt=t=>{Y(t.id)&&(hn(),ke()),Ln(t)},ot=!1;e.onNodeClick((t,a)=>{t&&(ot=!0,a&&typeof a.stopPropagation=="function"&&a.stopPropagation(),rt(t))}),typeof e.onBackgroundClick=="function"&&e.onBackgroundClick(()=>{ve(),pe(!1)});let ue=n.root.querySelector("#graph-landing-mount");if(ue instanceof HTMLElement){let t=null,a=c=>{t={x:c.clientX,y:c.clientY},Be(!1)},l=(c,m)=>{if(typeof e.graph2ScreenCoords!="function")return null;let g=ue.getBoundingClientRect(),p=c-g.left,T=m-g.top,v=null,$=4096;for(let S of q().nodes){if(S.x===void 0||S.y===void 0)continue;let O=e.graph2ScreenCoords(S.x,S.y,S.z??0),de=(O.x-p)**2+(O.y-T)**2,at=(O.x-c)**2+(O.y-m)**2,Nt=Math.min(de,at);Nt<$&&($=Nt,v=S)}return v},d=c=>{let m=t;t=null,Be(!0),!(!m||(c.clientX-m.x)**2+(c.clientY-m.y)**2>25)&&window.setTimeout(()=>{if(ot){ot=!1;return}let p=l(c.clientX,c.clientY);p?rt(p):ve()},0)},f=()=>{t=null,Be(!0)};ue.addEventListener("pointerdown",a,!0),ue.addEventListener("pointerup",d,!0),ue.addEventListener("pointercancel",f,!0),window.addCleanup(()=>{ue.removeEventListener("pointerdown",a,!0),ue.removeEventListener("pointerup",d,!0),ue.removeEventListener("pointercancel",f,!0)})}rn(n.root,"[data-graph-lens]",y.lens,"data-graph-lens"),Je(),Et(),y.lens!=="all"&&ke(),n.use3d||(typeof e.centerAt=="function"&&e.centerAt(0,0,0),typeof e.zoom=="function"&&e.zoom(1,0));let Mt=()=>{o.current=dn(),e.backgroundColor(Qe()),et(),n.bloomPass&&(n.bloomPass.strength=X()?Ut:0,n.bloomPass.radius=$t,n.bloomPass.threshold=Wt),ge(),ae(),Je()};document.addEventListener("themechange",Mt),window.addCleanup(()=>document.removeEventListener("themechange",Mt));let St=t=>{let a=t.target;if(!(a instanceof Element))return;if(a.closest("[data-graph-inspect-close]")){ve();return}if(a.closest("[data-graph-rail-toggle]")){let p=n.root.dataset.railOpen!=="true";p&&ve(),pe(p);return}if(a.closest("[data-graph-rail-scrim]")){pe(!1);return}let l=a.closest("[data-graph-inspect-id]");if(l instanceof HTMLElement&&l.dataset.graphInspectId){let p=n.fullData.nodes.find(T=>T.id===l.dataset.graphInspectId);p&&rt(p);return}let d=a.closest("[data-graph-lens]");if(d instanceof HTMLElement&&d.dataset.graphLens&&Sr(d.dataset.graphLens)){bn(d.dataset.graphLens);return}let f=a.closest("[data-graph-tag]");if(f instanceof HTMLElement&&f.dataset.graphTag){yn(f.dataset.graphTag);return}let c=a.closest("[data-graph-folder]");if(c instanceof HTMLElement&&c.dataset.graphFolder){wn(c.dataset.graphFolder);return}if(a.closest("[data-graph-relayout]")){e.d3ReheatSimulation();return}let m=a.closest("[data-graph-labels]");if(m instanceof HTMLButtonElement){y.allLabels=!y.allLabels,m.setAttribute("aria-pressed",y.allLabels?"true":"false");let p=m.dataset.labelShow??"Labels",T=m.dataset.labelHide??"Labels",v=y.allLabels?T:p;m.title=v,m.setAttribute("aria-label",v),ae();return}if(a.closest("[data-graph-theme]")){let p=X()?"light":"dark";document.documentElement.setAttribute("saved-theme",p),localStorage.setItem("theme",p),document.body.classList.remove("theme-dark","theme-light"),document.body.classList.add(`theme-${p}`),document.dispatchEvent(new CustomEvent("themechange",{detail:{theme:p}}));return}let g=a.closest("[data-graph-tags-toggle]");if(g instanceof HTMLButtonElement){let p=n.root.querySelector(".graph-landing__tags");if(p instanceof HTMLElement){let T=p.dataset.open==="true";p.dataset.open=T?"false":"true",g.setAttribute("aria-expanded",T?"false":"true")}}},Te=n.root.querySelector("[data-graph-node-scale]"),Le=n.root.querySelector("[data-graph-edge-scale]");if(Te instanceof HTMLInputElement){Te.value=String(Math.round(M.nodeScale*100));let t=()=>{M.nodeScale=Number(Te.value)/100,Ne(M),ge(),n.use3d&&ae()};Te.addEventListener("input",t),window.addCleanup(()=>Te.removeEventListener("input",t))}if(Le instanceof HTMLInputElement){Le.value=String(Math.round(M.edgeScale*100));let t=()=>{M.edgeScale=Number(Le.value)/100,Ne(M),ge()};Le.addEventListener("input",t),window.addCleanup(()=>Le.removeEventListener("input",t))}let Ee=n.root.querySelector("[data-graph-hub-gravity]");if(Ee instanceof HTMLInputElement){Ee.value=String(Math.round(M.hubGravity*100));let t=()=>{let a=Number(Ee.value)/100;M.hubGravity=Number.isFinite(a)?Math.min(2,Math.max(0,a)):1,Ne(M),P(),e.d3ReheatSimulation()};Ee.addEventListener("input",t),window.addCleanup(()=>Ee.removeEventListener("input",t))}let xe=n.root.querySelector("[data-graph-zoom]");if(xe instanceof HTMLInputElement){xe.value=String(Math.round(M.zoom*100));let t=()=>{M.zoom=Number(xe.value)/100,Ne(M),A(200)};xe.addEventListener("input",t),window.addCleanup(()=>xe.removeEventListener("input",t))}let Me=n.root.querySelector("[data-graph-spread]");if(Me instanceof HTMLInputElement){Me.value=String(Math.round(M.spread*100));let t=()=>{M.spread=Number(Me.value)/100,Ne(M),P(),e.d3ReheatSimulation()};Me.addEventListener("input",t),window.addCleanup(()=>Me.removeEventListener("input",t))}pe(!1),n.root.addEventListener("click",St),window.addCleanup(()=>n.root.removeEventListener("click",St));let Ct=t=>{if(t.key==="Escape"){if(n.root.dataset.railOpen==="true"){pe(!1);return}ve()}};window.addEventListener("keydown",Ct),window.addCleanup(()=>window.removeEventListener("keydown",Ct))}function Dr(){return window.matchMedia("(prefers-reduced-data: reduce)").matches}function _r(){try{return window.localStorage.getItem(wt)==="stopped"}catch(e){return console.error("[graph-landing] could not read ambient audio preference",e),!1}}function bt(e){try{if(e){window.localStorage.setItem(wt,"stopped");return}window.localStorage.removeItem(wt)}catch(r){console.error("[graph-landing] could not persist ambient audio preference",r)}}function Gr(e){let r=performance.now(),o=0,n=i=>{let s=Math.min(1,(i-r)/e.durationMs),h=s*s;e.apply(e.from+(e.to-e.from)*h),s<1&&(o=window.requestAnimationFrame(n))};return o=window.requestAnimationFrame(n),()=>{window.cancelAnimationFrame(o)}}function Rr(){let e=window.YT;return e&&typeof e.Player=="function"?Promise.resolve(e):new Promise((r,o)=>{let n=window,i=n.onYouTubeIframeAPIReady;if(n.onYouTubeIframeAPIReady=()=>{typeof i=="function"&&i();let s=n.YT;if(!s||typeof s.Player!="function"){o(new Error("graph-landing: YouTube API missing Player"));return}r(s)},!document.querySelector("script[data-graph-youtube-api]")){let s=document.createElement("script");s.src=zn,s.async=!0,s.dataset.graphYoutubeApi="1",s.addEventListener("error",()=>{o(new Error("graph-landing: YouTube API failed to load"))}),document.head.appendChild(s)}})}function Hr(e){return new e.api.Player(e.host,{videoId:e.videoId,width:"200",height:"113",playerVars:{autoplay:0,controls:0,disablekb:1,fs:0,iv_load_policy:3,modestbranding:1,mute:1,origin:window.location.origin,playsinline:1,rel:0},events:{onReady:r=>{e.onReady(r.target)},onStateChange:r=>{r.data===e.api.PlayerState.ENDED&&e.onEnded(r.target)},onError:()=>{console.error("[graph-landing] ambient YouTube player failed")}}})}function Fr(e){let r=e.querySelector("[data-graph-audio-toggle]"),o=e.querySelector("[data-graph-audio-host]"),n=e.querySelector("[data-graph-music-library-toggle]"),i=e.querySelector("[data-graph-music-library]"),s=e.querySelector("[data-graph-music-track-list]"),h=e.querySelector("[data-graph-music-status]");if(!(r instanceof HTMLButtonElement)||!(o instanceof HTMLElement)||!(n instanceof HTMLButtonElement)||!(i instanceof HTMLElement)||!(s instanceof HTMLElement)||!(h instanceof HTMLElement))return;let x=e.dataset.audioStop??"Stop music",C=e.dataset.audioPlay??"Play music",R=e.dataset.musicLibraryOpen??"Open record collection",Y=e.dataset.musicLibraryClose??"Close record collection",y=e.dataset.musicCurrentTrack??"Current track",te=[];try{let k=JSON.parse(e.dataset.graphMusicTracks??"[]");if(Array.isArray(k))for(let N of k){if(!N||typeof N!="object")continue;let I=N;typeof I.title!="string"||typeof I.url!="string"||I.artist!==void 0&&typeof I.artist!="string"||te.push({title:I.title,...typeof I.artist=="string"?{artist:I.artist}:{},url:I.url})}}catch{}let G=Dt(te);G.length===0&&G.push({title:"Ambient track",videoId:Ot});let M=0,L=null,K=!1,j=null,H=!_r(),z=!1,F=!1,Q=()=>G[M]??G[0]??{title:"Ambient track",videoId:Ot},Z=k=>{r.style.setProperty("--graph-music-artwork",`url("https://i.ytimg.com/vi/${k}/hqdefault.jpg")`)},J=()=>Q().videoId,V=()=>{s.replaceChildren(),G.forEach((k,N)=>{let I=document.createElement("button");I.type="button",I.className="graph-landing__music-track",I.dataset.graphMusicTrackIndex=String(N),I.setAttribute("aria-current",N===M?"true":"false");let E=document.createElement("img");E.className="graph-landing__music-track-cover",E.src=`https://i.ytimg.com/vi/${k.videoId}/hqdefault.jpg`,E.alt="",E.loading="lazy";let fe=document.createElement("span");fe.className="graph-landing__music-track-copy";let ae=document.createElement("span");if(ae.className="graph-landing__music-track-title",ae.textContent=k.title,fe.appendChild(ae),k.artist){let ye=document.createElement("span");ye.className="graph-landing__music-track-artist",ye.textContent=k.artist,fe.appendChild(ye)}I.append(E,fe),s.appendChild(I)}),h.textContent=`${y}: ${Q().title}`},B=k=>{e.dataset.musicLibraryOpen=k?"true":"false",i.hidden=!k,i.setAttribute("aria-hidden",k?"false":"true"),n.setAttribute("aria-expanded",k?"true":"false"),n.setAttribute("aria-label",k?Y:R),n.title=k?Y:R},W=k=>{r.setAttribute("aria-pressed",k?"true":"false"),r.setAttribute("aria-label",k?x:C),r.title=k?x:C,r.dataset.playing=k?"true":"false"},q=()=>{j&&(j(),j=null)},u=k=>{L&&L.setVolume(Math.max(0,Math.min(Ce,k)))},b=k=>{!H||z||(z=!0,W(!0),k.unMute(),u(0),k.playVideo(),q(),j=Gr({from:0,to:Ce,durationMs:On,apply:u}))},w=()=>{H=!1,z=!1,q(),bt(!0),L&&(L.mute(),L.pauseVideo(),u(0)),W(!1)},A=async()=>{if(!L)try{let k=await Rr();if(L)return;L=Hr({api:k,host:o,videoId:J(),onReady:N=>{K=!0,N.mute(),u(0),N.playVideo(),H&&F&&b(N)},onEnded:N=>{if(!H)return;M=(M+1)%G.length;let I=J();Z(I),V(),N.loadVideoById(I),u(z?Ce:0)}})}catch(k){console.error("[graph-landing] ambient audio unavailable",k)}},P=k=>{let N=k.target;if(!(N instanceof Element&&N.closest("[data-graph-audio-toggle], [data-graph-music-library-toggle], [data-graph-music-track-index]"))&&!(!H||z||Dr())){if(F=!0,K&&L){b(L);return}A()}},_=()=>{if(H&&z){w();return}if(F=!0,H=!0,bt(!1),K&&L){b(L);return}A()},ne=k=>{if(!(!Number.isInteger(k)||k<0||k>=G.length)){if(M=k,Z(J()),V(),B(!1),H=!0,F=!0,bt(!1),K&&L){L.loadVideoById(J()),z?(L.unMute(),L.playVideo(),u(Ce)):b(L);return}A()}},re=()=>{let k=e.dataset.musicLibraryOpen!=="true";if(k){e.dataset.railOpen="false";let N=e.querySelector("[data-graph-rail-toggle]"),I=e.querySelector("#graph-landing-rail"),E=e.querySelector("[data-graph-rail-scrim]");N instanceof HTMLButtonElement&&N.setAttribute("aria-expanded","false"),I instanceof HTMLElement&&I.setAttribute("aria-hidden","true"),E instanceof HTMLElement&&(E.hidden=!0)}B(k)},oe=k=>{let N=k.target;if(!(N instanceof Element))return;let I=N.closest("[data-graph-music-track-index]");I instanceof HTMLButtonElement&&ne(Number(I.dataset.graphMusicTrackIndex))},ee=k=>{if(e.dataset.musicLibraryOpen!=="true")return;let N=k.target;(!(N instanceof Element)||!N.closest(".graph-landing__music-dock"))&&B(!1)},se=k=>{k.key==="Escape"&&e.dataset.musicLibraryOpen==="true"&&(B(!1),k.stopImmediatePropagation())},ce=()=>{if(L){if(document.hidden){q(),L.pauseVideo();return}H&&z&&(L.playVideo(),u(Ce))}};Z(J()),W(!1),V(),B(!1),A(),r.addEventListener("click",_),n.addEventListener("click",re),s.addEventListener("click",oe),e.addEventListener("click",ee),e.addEventListener("pointerdown",P,!0),e.addEventListener("touchstart",P,{capture:!0,passive:!0}),document.addEventListener("visibilitychange",ce),window.addEventListener("keydown",se),window.addCleanup(()=>{r.removeEventListener("click",_),n.removeEventListener("click",re),s.removeEventListener("click",oe),e.removeEventListener("click",ee),e.removeEventListener("pointerdown",P,!0),e.removeEventListener("touchstart",P,!0),document.removeEventListener("visibilitychange",ce),window.removeEventListener("keydown",se),q(),L&&(L.pauseVideo(),L.destroy(),L=null)})}async function Or(){let e=document.querySelector(".graph-landing");if(!(e instanceof HTMLElement)||e.dataset.graphReady==="1")return;e.dataset.graphReady="1",Fr(e);let r=e.querySelector("#graph-landing-mount");if(!(r instanceof HTMLElement))throw new Error("graph-landing: mount element #graph-landing-mount is missing");let o=e.querySelectorAll("[data-graph-counts]"),n=e.dataset.locale??e.dataset.graphDefaultLocale??"ko",i=e.dataset.sourceLocale??e.dataset.graphDefaultLocale??"ko",s=(e.dataset.localePrefixes??"").split(",").map(E=>E.trim()).filter(E=>E.length>0),h=e.dataset.countsTemplate??"{n} nodes \\xB7 {m} edges",x=ie(e.dataset.maxRenderedNodes,E=>Number.parseInt(E,10)),C=e.dataset.expandHops?Number.parseInt(e.dataset.expandHops,10):1,R=Number.isFinite(C)?C:1,Y=e.dataset.tagCoocDisabled==="true"?!1:e.dataset.tagCoocMaxTagsPerNote||e.dataset.tagCoocMaxEdges?{maxTagsPerNote:e.dataset.tagCoocMaxTagsPerNote?Number.parseInt(e.dataset.tagCoocMaxTagsPerNote,10):void 0,maxEdges:e.dataset.tagCoocMaxEdges?Number.parseInt(e.dataset.tagCoocMaxEdges,10):void 0}:void 0,y=e.dataset.graphRenderMode==="3d"?"3d":"auto",te=e.dataset.graphLayoutFreezeAfterWarmup==="true",G=ie(e.dataset.graphLayoutWarmupTicks,E=>Number.parseInt(E,10)),M=ie(e.dataset.graphLayoutCooldownTicks,E=>Number.parseInt(E,10)),L=ie(e.dataset.graphLayoutChargeTheta,Number.parseFloat),K=e.dataset.graphLayoutIncrementalWarmup==="true",j=ie(e.dataset.graphLodLabelDistance,Number.parseFloat),H=ie(e.dataset.graphLodDotDistance,Number.parseFloat),z=ie(e.dataset.graphLodCullDistance,Number.parseFloat),F=e.dataset.graphLodFog==="true",Q=ie(e.dataset.graphLodNodeResolution,E=>Number.parseInt(E,10)),Z=ie(e.dataset.graphLodLinkResolution,E=>Number.parseInt(E,10)),J=e.dataset.graphInteractionIncrementalRepaint==="true",V=e.dataset.graphLodShareLinkResources==="true",B=!1,W=null,q={current:dn()},u=()=>{B=!0,W&&(W._destructor(),W=null),delete e.dataset.graphReady};window.addCleanup(u);let b=br();if(y==="3d"&&!b){pt(r,"3D graph unavailable: WebGL is required and motion must be enabled.");return}let w=y==="3d"||b,A=Er(w),P=w?import(An).then(E=>E.default??null).catch(E=>(console.error("[graph-landing] SpriteText unavailable; 3D hub labels disabled",E),null)):Promise.resolve(null),_=w?import(Pn).catch(E=>(console.error("[graph-landing] three unavailable; using default node spheres",E),null)):Promise.resolve(null),ne=w?import(Dn).then(E=>E.UnrealBloomPass?new E.UnrealBloomPass:null).catch(E=>(console.error("[graph-landing] UnrealBloomPass unavailable; dark-mode bloom disabled",E),null)):Promise.resolve(null);A.catch(()=>{});let re;try{re=kt(await fetchData)}catch(E){throw pt(r,"Graph could not load content index."),E}if(B)return;let oe=pr(tr(re),{localeId:n,sourceLocale:i,prefixes:s},Y),ee=_t(oe,x),se=h.replace("{n}",String(ee.nodes.length)).replace("{m}",String(ee.links.length));for(let E of o)E.textContent=se;let ce;try{ce=await A}catch(E){throw pt(r,"Graph could not load. Check your network connection."),E}let[k,N,I]=await Promise.all([P,_,ne]);B||(r.replaceChildren(),W=ce(r),r.__graphLanding=W,r.__graphData=ee,Pr(W,ee,q,{use3d:w,root:e,spriteText:k,bloomPass:I,three:N,fullData:oe,expandHops:R,layout:{freezeAfterWarmup:te,warmupTicks:G,cooldownTicks:M,chargeTheta:L,incrementalWarmup:K},lod:{labelDistance:j,dotDistance:H,cullDistance:z,fog:F,nodeResolution:Q,linkResolution:Z,shareLinkResources:V},interaction:{incrementalRepaint:J}}))}var zr="preferred-locale";document.addEventListener("click",e=>{let r=e.target;if(!(r instanceof Element))return;let o=r.closest("a[data-preferred-locale]");if(!(o instanceof HTMLAnchorElement))return;let n=o.dataset.preferredLocale;if(n)try{localStorage.setItem(zr,n)}catch(i){console.error("[graph-landing] failed to persist preferred-locale",i)}});document.addEventListener("nav",()=>{Or()});\n';
