...
![[80. References/87. Eagle/r15ci_Upstage AI Ambassador 2기 No Code 기반 자동화 워크플로우_MN8O5Y5QK4GAF.png]]
...
[[Process Manager 2 (PM2)|PM2]] 를 사용하여 n8n 프로세스를 상시 운영합니다. `ecosystem.config.js` 에서 `autorestart: true` 로 크래시 시 자동 재시작하고, `max_memory_restart: '512M'` 으로 메모리 초과 시에도 자동 복구합니다. 실행 명령은 아래와 같습니다.
